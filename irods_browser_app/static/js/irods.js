    ...
    function set_store_display(store, parent, margin, json) {
        ...
        if (files.length == 0 && folder.length == 0) {
            ...
            $.each(folder, function(i, v) {
                $(parent).append("<div class='folder' id='irods_folder_" + v + "' name='" + store + "/" + v + "' style='margin-left:" + margin + "px;'><img src='"+ `${STATIC_URL}img/folder.png' ` + "width='15' height='15'>&nbsp; " + v + "</div>");
            });

            $.each(files, function(i, v) {
                $(parent).append("<div class='file' id='irods_file_" + v + "' name='" + store + "/" + v + "' style='margin-left:" + margin + "px;'><img src='"+ `${STATIC_URL}img/file.png' ` + "width='15' height='15'>&nbsp; " + v + "</div>")
            });
        }
