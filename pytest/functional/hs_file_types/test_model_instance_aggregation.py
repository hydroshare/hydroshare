...
def test_update_spatial_coverage_from_children(composite_resource_with_mi_aggregation_folder):
    ...
    assert mi_aggr.metadata.spatial_coverage.value['northlimit'] == pytest.approx(42.050026959773426)
    assert mi_aggr.metadata.spatial_coverage.value['eastlimit'] == pytest.approx(-111.577737181062)
    assert mi_aggr.metadata.spatial_coverage.value['southlimit'] == pytest.approx(41.98722286030319)
    assert mi_aggr.metadata.spatial_coverage.value['westlimit'] == pytest.approx(-111.69756293084063)
    ...
    assert mi_aggr.metadata.spatial_coverage.value['northlimit'] == pytest.approx(42.050026959773426)
    assert mi_aggr.metadata.spatial_coverage.value['eastlimit'] == pytest.approx(-111.5059403684569)
    assert mi_aggr.metadata.spatial_coverage.value['southlimit'] == pytest.approx(41.86390807452128)
    assert mi_aggr.metadata.spatial_coverage.value['westlimit'] == pytest.approx(-111.69756293084063)
    assert not resource.dangling_aggregations_exist()
...
def test_no_auto_update_spatial_coverage_from_children(composite_resource_with_mi_aggregation_folder):
    ...
    assert gr_aggr.metadata.spatial_coverage.value['northlimit'] == pytest.approx(42.050026959773426)
    assert gr_aggr.metadata.spatial_coverage.value['eastlimit'] == pytest.approx(-111.577737181062)
    assert gr_aggr.metadata.spatial_coverage.value['southlimit'] == pytest.approx(41.98722286030319)
    assert gr_aggr.metadata.spatial_coverage.value['westlimit'] == pytest.approx(-111.69756293084063)
