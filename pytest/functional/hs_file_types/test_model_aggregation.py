...
def test_create_aggregation_from_file_1(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_create_aggregation_from_file_2(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_create_aggregation_from_file_3(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_create_aggregation_from_folder(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_create_aggregation_from_parent_folder(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_create_aggregation_from_folder_inside_fileset(composite_resource, aggr_cls):
    """test that we can create a model program/instance aggregation from a folder that contains a resource file
...
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_move_aggregation_to_fileset(composite_resource, aggr_folder, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_upload_file_to_aggregation_folder(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_upload_file_to_aggregation_sub_folder(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_create_aggregation_from_folder_failure_1(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_create_aggregation_from_folder_failure_2(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_create_aggregation_from_folder_failure_3(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_create_fileset_from_folder_failure(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_delete_aggregation_res_file_1(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_delete_aggregation_res_file_2(composite_resource, aggr_cls):
...
def test_move_model_aggr_into_model_aggr_folder_failure(composite_resource, aggr_cls, move_type):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_move_fileset_into_model_aggr_folder_failure(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_move_model_aggregation_file_1(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_move_model_aggregation_file_2(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_rename_model_aggregation_folder(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.parametrize('aggr_cls', [ModelProgramLogicalFile, ModelInstanceLogicalFile])
def test_delete_model_aggregation_folder(composite_resource, aggr_cls):
...
@pytest.mark.django_db(transaction=True)
def test_resource_copy(composite_resource):
...
@pytest.mark.django_db(transaction=True)
def test_resource_copy_with_aggregations_with_no_files(composite_resource):
...
def test_resource_copy_after_aggr_delete(composite_resource, aggr_to_delete):
