    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(related_name='creator_of_ref_ts_reftimeseries', to=settings.AUTH_USER_MODEL, help_text='This is the person who first uploaded the resource')),
                ('edit_groups', models.ManyToManyField(help_text='This is the set of Hydroshare Groups who can edit the resource', related_name='group_editable_ref_ts_reftimeseries', null=True, to='auth.Group', blank=True)),
                ('edit_users', models.ManyToManyField(help_text='This is the set of Hydroshare Users who can edit the resource', related_name='user_editable_ref_ts_reftimeseries', null=True, to=settings.AUTH_USER_MODEL, blank=True)),
                ('last_changed_by', models.ForeignKey(related_name='last_changed_ref_ts_reftimeseries', to=settings.AUTH_USER_MODEL, help_text='The person who last changed the resource', null=True)),
                ('owners', models.ManyToManyField(help_text='The person who has total ownership of the resource', related_name='owns_ref_ts_reftimeseries', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(related_name='reftimeseriess', verbose_name='Author', to=settings.AUTH_USER_MODEL)),
                ('view_groups', models.ManyToManyField(help_text='This is the set of Hydroshare Groups who can view the resource', related_name='group_viewable_ref_ts_reftimeseries', null=True, to='auth.Group', blank=True)),
                ('view_users', models.ManyToManyField(help_text='This is the set of Hydroshare Users who can view the resource', related_name='user_viewable_ref_ts_reftimeseries', null=True, to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
                'ordering': ('_order',),
