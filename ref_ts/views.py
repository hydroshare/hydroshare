...
def get_his_urls(request):
    try:
        ...
        logger.exception("get_his_urls: " + e.msg)
...
def search_sites(request):
    try:
        ...
        logger.exception("search_sites: " + e.msg)
        return json_or_jsonp(request, {"status": "error"})
...
def search_variables(request):
    try:
        ...
        logger.exception("search_variables: %s" % (e.msg))
        return json_or_jsonp(request, {"status": "error"})
...
def time_series_from_service(request):
    ...
    try:
        ...
        logger.exception("time_series_from_service: %s" % (e.msg))
...
def download_refts_resource_bag(request, shortkey, *args, **kwargs):
    ...
    try:
        ...
        logger.exception("download_refts_resource_bag: %s" % (e.msg))
...
def rest_download_refts_resource_bag(request, shortkey, *args, **kwargs):
    ...
    try:
        ...
        logger.exception("rest_download_refts_resource_bag: %s" % (e.msg))
        response = HttpResponse(status=503)
