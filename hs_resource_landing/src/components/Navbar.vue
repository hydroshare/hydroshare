...
<!--    TODO removed tag directives-->
    <div id="toplevel-nav-container" class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/landingPage"><img id="img-brand-logo" src="/static/img/logo-lg.png" /></a>
      </div>
...
<!--                         title="{{ request.user.email }}">{{ request.user.email }}-->
<!--                    </div>-->
<!--                    {% endif %}-->
<!--                  </div>-->
                </div>
        ...
        <ul class="nav navbar-nav"><li>links links links</li>
<!--          <li {% if request.path==-->
<!--          "/home/" %}class="active"{% endif %} id="dropdown-menu-home">-->
<!--          <a href="/home/">Home</a>-->
<!--          </li>-->
<!--          <li {% if request.path==-->
<!--          "/my-resources/" %}class="active"{% endif %} id="dropdown-menu-my-resources">-->
<!--          <a href="/my-resources/">My Resources</a>-->
<!--          </li>-->
<!--          <li {% if request.path==-->
<!--          "/search/" %}class="active"{% endif %} id="dropdown-menu-search">-->
<!--          <a href="/search/">Discover</a>-->
<!--          </li>-->
<!--          <li {% if request.path==-->
<!--          "/collaborate/" %}class="active"{% endif %} id="dropdown-menu-collaborate">-->
...
<!--          </li>-->
        ...
        <ul id="resource-dropdown" class="nav navbar-nav navbar-right">
          ...
          <li v-if="user.is_authenticated" class="visible-xs"><a href="/user/{{ user.id }}/">Profile</a></li>

          <!-- TODO Profile links for extra small screens -->
<!--          TODO enable logout-->
          <li v-if="user.is_authenticated" class="visible-xs"><a href="logout">
            <span class="glyphicon glyphicon-log-out"></span> Sign Out</a></li>
          <li v-else class="visible-xs"><a href="login">
...
export default {
  ...
  methods: {
    doTest() {
      console.log('Navbar test success');
    },
  },
};
</script>
