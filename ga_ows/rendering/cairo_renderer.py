...
class RenderingContext(object):
    ...
    def sketch_feature(self, g):
        if g.geom_type is 'Point':
            self.sketch_point(g)
        elif g.geom_type is 'LineString':
            self.sketch_linestring(g)
        elif g.geom_type is 'MultiLineString':
             self.sketch_multilinestring(g)
        elif g.geom_type is 'Polygon':
            self.sketch_polygon(g)
        elif g.geom_type is 'MultiPolygon':
             self.sketch_multipolygon(g)
        elif g.geom_type is 'GeometryCollection':
            self.sketch_collection(g)
        elif g.geom_type is 'LinearRing':
