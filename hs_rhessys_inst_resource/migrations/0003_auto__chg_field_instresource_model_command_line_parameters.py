...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstResource.model_command_line_parameters'
        db.alter_column(u'hs_rhessys_inst_resource_instresource', 'model_command_line_parameters', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'InstResource.model_command_line_parameters'
        db.alter_column(u'hs_rhessys_inst_resource_instresource', 'model_command_line_parameters', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'hs_rhessys_inst_resource.instresource': {
            ...
            'model_command_line_parameters': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            ...
            'short_id': ('django.db.models.fields.CharField', [], {'default': "'2e98d2c3536644929ccb0164d48362fb'", 'max_length': '32', 'db_index': 'True'}),
