...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstResource.object_id'
        db.add_column(u'hs_rhessys_inst_resource_instresource', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InstResource.content_type'
        db.add_column(u'hs_rhessys_inst_resource_instresource', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstResource.object_id'
        db.delete_column(u'hs_rhessys_inst_resource_instresource', 'object_id')

        # Deleting field 'InstResource.content_type'
        db.delete_column(u'hs_rhessys_inst_resource_instresource', 'content_type_id')
    ...
    models = {
        ...
        u'hs_rhessys_inst_resource.instresource': {
            ...
            'short_id': ('django.db.models.fields.CharField', [], {'default': "'cf38535956914bab8f7d0728bbb961e3'", 'max_length': '32', 'db_index': 'True'}),
