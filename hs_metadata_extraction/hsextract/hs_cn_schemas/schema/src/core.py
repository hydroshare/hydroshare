...
class CoreMetadata(SchemaBaseModel):
    ...
    creator:
        List[Union[Creator, Organization]] = Field(
    ...
    license:
        Union[CreativeWork, HttpUrl] = Field(
            description="A license document that applies to the resource."
        )
    provider:
        Union[Organization, Provider] = Field(
    ...
    ###################
    contributor:
        Optional[List[Union[Contributor, Organization]]] = Field(
            description="Person or Organization that contributed to the resource.",
            default=None
        )
    publisher:
        Optional[PublisherOrganization] = Field(
            title="Publisher",
    ...
    inLanguage:
        Optional[Union[LanguageEnum, InLanguageStr]] = Field(
            title="Language",
            description="The language of the content of the resource.",
            default=None,
        )
    creativeWorkStatus:
        Optional[Union[Draft, Incomplete, Obsolete, Published]] = Field(
    ...
    temporalCoverage:
        Optional[TemporalCoverage] = Field(
    ...
    # using MediaType here to allow for MediaObject and its subclasses (e.g.,
    # DataDownload, VideoObject)
    associatedMedia:
        Optional[Union[MediaType, List[MediaType]]] = Field(
