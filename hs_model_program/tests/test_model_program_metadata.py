...
class TestModelProgramMetaData(MockIRODSTestCaseMixin, TransactionTestCase):
    def setUp(self):
        ...
        d = 'hs_model_program/tests/MP_test_files/'
        self.file_list = []
    ...
    def test_allowed_file_types(self):
        ...
        utils.resource_file_add_pre_process(resource=self.resModelProgram, files=files, user=self.user,
        ...
        self.assertEquals(self.resModelProgram.metadata.mpmetadata, None)
        ...
        # check that there are no extended metadata elements at this point
        self.assertEquals(self.resModelInstance.metadata.mpmetadata, None)
