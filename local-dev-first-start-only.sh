...
HYDROSHARE_CONTAINERS=(hydroshare defaultworker redpanda redpanda-console s3eventworker postgis companion redis nginx minio micro-auth pgbouncer discovery-atlas)
HYDROSHARE_VOLUMES=(hydroshare_postgis_data_vol hydroshare_redpanda_data_vol hydroshare_share_vol hydroshare_temp_vol hydroshare_minio_data_vol hydroshare_redis_data_vol hydroshare_companion_vol)
HYDROSHARE_IMAGES=(hydroshare-defaultworker hydroshare-hydroshare postgis/postgis redpanda redpanda-console hydroshare-s3eventworker nginx redis transloadit/companion minio/minio edoburu/pgbouncer hydroshare-micro-auth hydroshare-discovery-atlas)
