...
COPY --from=hydroshare/hs-discover:latest /dist/js /hydroshare/hs_discover/static/
COPY --from=hydroshare/hs-discover:latest /dist/css /hydroshare/hs_discover/static/
COPY --from=hydroshare/hs-discover:latest /dist/map.js /hydroshare/hs_discover/static/js/
