  ...
  filter: { [key: string]: Filter } = {
    ...
    contentType: new Filter({
      ...
      options: [
        ...
        {
          value: "CSVFileAggregation",
          label: "CSV Data",
          logo: "",
        },
        {
          value: "SingleFileAggregation",
          label: "Single File Generic Data",
          logo: "",
        },
        {
          value: "FileSetAggregation",
        ...
        {
          value: "GeographicRasterAggregation",
          label: "Geographic Raster",
          logo: "",
        },
        {
          value: "ModelInstanceAggregation",
          label: "Model Instance",
          logo: "",
        },
        {
          value: "ModelProgramAggregation",
          label: "Model Program",
          logo: "",
        },
        {
        ...
        {
          value: "ReferencedTimeSeriesAggregation",
