                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="subject" class="facet-list panel-collapse collapse in">
                                <ul class="list-group" id="list-group-subject">
                                    <li class="list-group-item" rel="subject,mmw">
                                        <span class="badge">559</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections" id="subject-mmw"
                                                   value="subject,mmw">mmw</label>
                                    </li>
                                    <li class="list-group-item"
                                        rel="subject,susquehanna shale hills critical zone observatory">
                                        <span class="badge">92</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections"
                                                   id="subject-susquehanna shale hills critical zone observatory"
                                                   value="subject,susquehanna shale hills critical zone observatory">susquehanna
                                            shale hills critical zone observatory</label>
                                    </li>
                                    <li class="list-group-item" rel="subject,USACE">
                                        <span class="badge">91</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections" id="subject-USACE"
                                                   value="subject,USACE">USACE</label>
                                    </li>
                                    <li class="list-group-item" rel="subject,soil moisture">
                                        <span class="badge">87</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections" id="subject-soil moisture"
                                                   value="subject,soil moisture">soil moisture</label>
                                    </li>
                                    <li class="list-group-item" rel="subject,catalina-jemez">
                                        <span class="badge">67</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections"
                                                   id="subject-catalina-jemez" value="subject,catalina-jemez">catalina-jemez</label>
                                    </li>
                                    <li class="list-group-item" rel="subject,fiber optic">
                                        <span class="badge">66</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections" id="subject-fiber optic"
                                                   value="subject,fiber optic">fiber optic</label>
                                    </li>
                                    <li class="list-group-item" rel="subject,discharge">
                                        <span class="badge">65</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections" id="subject-discharge"
                                                   value="subject,discharge">discharge</label>
                                    </li>
                                    <li class="list-group-item" rel="subject,time series">
                                        <span class="badge">65</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections" id="subject-time series"
                                                   value="subject,time series">time series</label>
                                    </li>
                                    <li class="list-group-item" rel="subject,volumetric water content">
                                        <span class="badge">65</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections"
                                                   id="subject-volumetric water content"
                                                   value="subject,volumetric water content">volumetric water
                                            content</label>
                                    </li>
                                    <li class="list-group-item" rel="subject,USU">
                                        <span class="badge">64</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections" id="subject-USU"
                                                   value="subject,USU">USU</label>
                                    </li>
                                    <li class="list-group-item" rel="subject,luquillo">
                                        <span class="badge">61</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections" id="subject-luquillo"
                                                   value="subject,luquillo">luquillo</label>
                                    </li>
                                    <li class="list-group-item" rel="subject,soil geochemistry">
                                        <span class="badge">31</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections"
                                                   id="subject-soil geochemistry" value="subject,soil geochemistry">soil
                                            geochemistry</label>
                                    </li>
                                    <li class="list-group-item" rel="subject,ECMWF">
                                        <span class="badge">30</span>
                                        <label class="checkbox noselect">
                                            <input type="checkbox" class="faceted-selections" id="subject-ECMWF"
                                                   value="subject,ECMWF">ECMWF</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
