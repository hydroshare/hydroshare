    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owners', models.ManyToManyField(help_text=b'The person who uploaded the resource', related_name='owns_hs_core_genericresource', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('object_id', models.PositiveIntegerField()),
                ('type', models.CharField(max_length=100, choices=[(b'isPartOf', b'Part Of'), (b'isExecutedBy', b'Executed By'), (b'isCreatedBy', b'Created By'), (b'isVersionOf', b'Version Of'), (b'isDataFor', b'Data For')])),
        ...
        migrations.AlterUniqueTogether(
            name='externalprofilelink',
            unique_together=set([('type', 'url', 'content_type')]),
        ),
        migrations.AlterUniqueTogether(
            name='description',
            unique_together=set([('content_type', 'object_id')]),
