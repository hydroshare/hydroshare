    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(related_name='creator_of_hs_core_genericresource', to=settings.AUTH_USER_MODEL, help_text='This is the person who first uploaded the resource')),
                ...
                ('last_changed_by', models.ForeignKey(related_name='last_changed_hs_core_genericresource', to=settings.AUTH_USER_MODEL, help_text='The person who last changed the resource', null=True)),
