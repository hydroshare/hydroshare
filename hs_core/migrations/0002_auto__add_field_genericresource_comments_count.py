...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GenericResource.comments_count'
        db.add_column(u'hs_core_genericresource', u'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GenericResource.comments_count'
        db.delete_column(u'hs_core_genericresource', u'comments_count')
    ...
    models = {
        ...
        u'hs_core.genericresource': {
            ...
            'resource_file': ('django.db.models.fields.files.FileField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
