...
class TestCaseCommonUtilities(object):
    ...
    def raster_metadata_extraction(self):
        ...
        self.assertEqual(float("%0.9f" % float(box_coverage.value['northlimit'])), 42.11270614966863)
        self.assertEqual(float("%0.9f" % float(box_coverage.value['eastlimit'])), -111.45699925047542)
        self.assertEqual(float("%0.9f" % float(box_coverage.value['southlimit'])), 41.66222054591102)
        self.assertEqual(float("%0.9f" % float(box_coverage.value['westlimit'])), -111.81761887121905)
        ...
        self.assertEqual(float("%0.9f" % float(ori_coverage.value['northlimit'])), 4662392.446916306)
        self.assertEqual(float("%0.9f" % float(ori_coverage.value['eastlimit'])), 461954.01909127034)
        self.assertEqual(float("%0.9f" % float(ori_coverage.value['southlimit'])), 4612592.446916306)
        self.assertEqual(float("%0.9f" % float(ori_coverage.value['westlimit'])), 432404.01909127034)
    ...
    def netcdf_metadata_extraction(self, expected_creators_count=1):
        ...
        self.assertEqual(box_coverage.value['projection'], 'WGS 84 EPSG:4326')
        self.assertEqual(box_coverage.value['units'], 'Decimal degrees')
        self.assertEqual(float("%0.9f" % float(box_coverage.value['northlimit'])), 41.867126409)
        self.assertEqual(float("%0.9f" % float(box_coverage.value['eastlimit'])), -111.505940368)
        self.assertEqual(float("%0.9f" % float(box_coverage.value['southlimit'])), 41.8639080745)
        self.assertEqual(float("%0.9f" % float(box_coverage.value['westlimit'])), -111.51138808)
        ...
        self.assertEqual(float("%0.9f" % float(ori_coverage.value['northlimit'])), 4.63515e+06)
        self.assertEqual(float("%0.9f" % float(ori_coverage.value['eastlimit'])), 458010.0)
        self.assertEqual(float("%0.9f" % float(ori_coverage.value['southlimit'])), 4.63479e+06)
        self.assertEqual(float("%0.9f" % float(ori_coverage.value['westlimit'])), 457560.0)
        self.assertEqual(ori_coverage.value['units'], 'Meter')
    ...
    def timeseries_metadata_extraction(self):
        ...
        self.assertEqual(box_coverage.value['projection'], 'WGS 84 EPSG:4326')
        self.assertEqual(box_coverage.value['units'], 'Decimal degrees')
        self.assertEqual(float("%0.9f" % float(box_coverage.value['northlimit'])), 41.718473)
        self.assertEqual(float("%0.9f" % float(box_coverage.value['eastlimit'])), -111.799324)
        self.assertEqual(float("%0.9f" % float(box_coverage.value['southlimit'])), 41.495409)
        self.assertEqual(float("%0.9f" % float(box_coverage.value['westlimit'])), -111.946402)
