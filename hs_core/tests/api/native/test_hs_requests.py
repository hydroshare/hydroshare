...
class TestRewrite(TestCase):
    ...
    def test_localize_outer(self):
        ...
        self.assertEqual(
            hs_requests.localize_url("https://{}/foo/bar/".format(self.fqdn)),
            "https://{}/foo/bar/".format(self.nginx_ip),
        )
        self.assertEqual(
            hs_requests.localize_url("http://{}/foo/bar/".format(self.fqdn)),
    ...
    def test_localize_www(self):
        ...
        self.assertEqual(
            hs_requests.localize_url("https://{}/foo/bar/".format(self.prod_fqdn)),
            "https://{}/foo/bar/".format(self.nginx_ip),
        )
        self.assertEqual(
            hs_requests.localize_url("http://{}/foo/bar/".format(self.prod_fqdn)),
            "http://{}/foo/bar/".format(self.nginx_ip),
        )
    ...
    def test_do_not_localize_others(self):
        ...
        self.assertEqual(
            hs_requests.localize_url("https://{}/foo/bar/".format("www.foo.com")),
            "https://{}/foo/bar/".format("www.foo.com"),
        )
        self.assertEqual(
            hs_requests.localize_url("http://{}/foo/bar/".format("www.foo.com")),
