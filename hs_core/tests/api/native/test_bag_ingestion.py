...
def compare_metadatas(self, short_id, new_metadata_str, original_metadata_file):
    def normalize_metadata(metadata_str):
        ...
        return metadata_str.replace(
            current_site_url(), "http://www.hydroshare.org"
    ...
    is_resource = new_graph.value(
        predicate=DC.type,
        object=URIRef("http://www.hydroshare.org/terms/CompositeResource"),
    )
    if is_resource:
        ...
        modified_subject = original_graph.value(
            predicate=RDF.type, object=DCTERMS.modified
        )
    ...
    for (new_triple, original_triple) in _squashed_graphs_triples(
        new_graph, original_graph
    ):
        self.assertEquals(
            new_triple, original_triple, "Ingested metadata does not match original"
        )
...
class TestIngestMetadata(MockIRODSTestCaseMixin, TestCase):
    ...
    def test_nested_fileset_ingestion(self):
        ...
        compare_metadatas(
            self,
            self.res.short_id,
            self.res.get_logical_files(FileSetLogicalFile.type_name())[
                0
            ].metadata.get_xml(),
        ...
        compare_metadatas(
            self,
            self.res.short_id,
            self.res.get_logical_files(GenericLogicalFile.type_name())[
                0
            ].metadata.get_xml(),
    ...
    def test_modelinstance_ingestion(self):
        ...
        compare_metadatas(
            self,
            self.res.short_id,
            self.res.get_logical_files(ModelInstanceLogicalFile.type_name())[
                0
            ].metadata.get_xml(),
    ...
    def test_modelprogram_ingestion(self):
        ...
        compare_metadatas(
            self,
            self.res.short_id,
            self.res.get_logical_files(ModelProgramLogicalFile.type_name())[
                0
            ].metadata.get_xml(),
    ...
    def test_timeseries_ingestion(self):
        ...
        compare_metadatas(
            self,
            self.res.short_id,
            self.res.get_logical_files(TimeSeriesLogicalFile.type_name())[
                0
            ].metadata.get_xml(),
    ...
    def test_netcdf_ingestion(self):
        ...
        compare_metadatas(
            self,
            self.res.short_id,
            self.res.get_logical_files(NetCDFLogicalFile.type_name())[
                0
            ].metadata.get_xml(),
    ...
    def test_geofeature_ingestion(self):
        ...
        compare_metadatas(
            self,
            self.res.short_id,
            self.res.get_logical_files(GeoFeatureLogicalFile.type_name())[
                0
            ].metadata.get_xml(),
    ...
    def test_resource_ingestion(self):
        ...
        compare_metadatas(
            self,
            self.res.short_id,
            self.res.metadata.get_xml(),
            "resource/resourcemetadata.xml",
        )
    ...
    def test_georaster_ingestion(self):
        ...
        compare_metadatas(
            self,
            self.res.short_id,
            self.res.get_logical_files(GeoRasterLogicalFile.type_name())[
                0
            ].metadata.get_xml(),
    ...
    def test_reftimeseries_ingestion(self):
        ...
        compare_metadatas(
            self,
            self.res.short_id,
            self.res.get_logical_files(RefTimeseriesLogicalFile.type_name())[
                0
            ].metadata.get_xml(),
