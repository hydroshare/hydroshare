...
class TestSetAccessRules(HSRESTTestCase):
    ...
    def test_get_access_rules_via_sysmeta(self):
        ...
        new_res = resource.create_resource(rtype, self.user, title, keywords=keywords)
    ...
    def test_set_and_delete_user_resource_access(self):
        ...
        put_response = self.client.put(
            access_url,
            {"privilege": PrivilegeCodes.VIEW, "user_id": self.secondUser.id},
            format="json",
        )
        self.assertEqual(
            "Resource access privileges added.", put_response.data["success"]
        )
        ...
        delete_response = self.client.delete(
            access_url + "?user_id=" + str(self.secondUser.id)
        )
        self.assertEqual(
            "Resource access privileges removed.", delete_response.data["success"]
        )
    ...
    def test_set_and_delete_group_resource_access(self):
        ...
        put_response = self.client.put(
            access_url,
            {"privilege": PrivilegeCodes.VIEW, "group_id": self.testGroup.id},
            format="json",
        )
        self.assertEqual(
            "Resource access privileges added.", put_response.data["success"]
        ...
        delete_response = self.client.delete(
            access_url + "?group_id=" + str(self.testGroup.id)
        )
        self.assertEqual(
            "Resource access privileges removed.", delete_response.data["success"]
        )
    ...
    def test_no_access(self):
        ...
        new_res = resource.create_resource(
            rtype, self.secondUser, title, keywords=keywords
        )
        new_res.metadata.create_element("description", abstract=abstract)
        res_id = new_res.short_id
        self.resources_to_delete.append(res_id)
    ...
    def test_errors(self):
        ...
        put_response = self.client.put(
            access_url,
            {"user_id": self.secondUser.id, "group_id": self.testGroup.id},
            format="json",
        )
        self.assertEqual(
