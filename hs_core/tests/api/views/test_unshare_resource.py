...
class TestUnshareResource(MockIRODSTestCaseMixin, TestCase):
    ...
    def test_unshare_resource_with_user(self):
        ...
        self.owner.uaccess.share_resource_with_user(
            self.gen_res, self.user, PrivilegeCodes.VIEW
        )
        ...
        self.owner.uaccess.share_resource_with_user(
            self.gen_res, self.user, PrivilegeCodes.CHANGE
        )
        ...
        self.owner.uaccess.share_resource_with_user(
            self.gen_res, self.user, PrivilegeCodes.OWNER
        )
    ...
    def test_unshare_resource_with_self(self):
        ...
        response = unshare_resource_with_user(
            request, shortkey=self.gen_res.short_id, user_id=self.user.id
        )
    ...
    def test_unshare_resource_with_group(self):
        ...
        self.owner.uaccess.share_resource_with_group(
            self.gen_res, self.test_group, PrivilegeCodes.VIEW
        )
        ...
        self.owner.uaccess.share_resource_with_group(
            self.gen_res, self.test_group, PrivilegeCodes.CHANGE
        )
    ...
    def test_unshare_resource_with_group_bad_request(self):
        ...
        with self.assertRaises(PermissionDenied):
            unshare_resource_with_group(
                request, shortkey=self.gen_res.short_id, group_id=self.test_group.id
            )
