...
class TestGetUserData(TestCase):
    ...
    def test_get_user_data(self):
        ...
        response = get_user_or_group_data(
            request, user_or_group_id=self.john.id, is_group="false"
        )
    ...
    def test_get_user_data_failure(self):
        ...
        with self.assertRaises(Http404):
            get_user_or_group_data(
                request, user_or_group_id=non_existing_user_id, is_group="false"
            )
