...
def get_page_context(page, user, resource_edit=False, extended_metadata_layout=None, request=None):
    ...
    if not resource_edit:
        ...
        context = {
                   ...
                   'relations': content_model.metadata.relations.exclude(type="inspecificRelation"),
                   'inspecific_relations': content_model.metadata.relations.filter(type="inspecificRelation"),
