...
def get_page_context(page, user, resource_edit=False, extended_metadata_layout=None, request=None):
    ...
    if not resource_edit:
        ...
        if temporal_coverage:
            ...
            temporal_coverage_data_dict['start_date'] = '{0.year:4d},{0.month:02d},{0.day:02d},{0.hour},{0.minute}'.format(start_date)
            temporal_coverage_data_dict['end_date'] = '{0.year:4d},{0.month:02d},{0.day:02d},{0.hour},{0.minute}'.format(end_date)
    ...
    if temporal_coverage:
        start_date = parser.parse(temporal_coverage.value['start'])
        end_date = parser.parse(temporal_coverage.value['end'])
        temporal_coverage_data_dict['start'] = '{0.year:4d},{0.month:02d},{0.day:02d},{0.hour},{0.minute}'.format(start_date)
        temporal_coverage_data_dict['end'] = '{0.year:4d},{0.month:02d},{0.day:02d},{0.hour},{0.minute}'.format(end_date)
        temporal_coverage_data_dict['name'] = temporal_coverage.value.get('name', '')
