...
class ResourceFolders(APIView):
    ...
    def get(self, request, pk, pathname):
        ...
        if not resource.supports_folders:
            return Response(
                "Resource type does not support subfolders",
    ...
    def put(self, request, pk, pathname):
        ...
        return Response(
            data={"resource_id": pk, "path": pathname}, status=status.HTTP_201_CREATED
        )
    ...
    def delete(self, request, pk, pathname):
        ...
        return Response(
            data={"resource_id": pk, "path": pathname}, status=status.HTTP_200_OK
        )
