...
urlpatterns = patterns('',
    ...
    url(r'^_internal/create-user-group/$', views.create_user_group),
    url(r'^_internal/update-user-group/$', views.update_user_group),
    ...
    url(r'^_internal/group_membership/(?P<token>[-\w]+)/(?P<uidb36>[-\w]+)/', views.group_membership,
