...
urlpatterns = [
    ...
    url(
        r"^_internal/create-user-group/$",
        views.create_user_group,
        name="create_user_group",
    ),
    url(
        r"^_internal/update-user-group/(?P<group_id>[0-9]+)$",
        views.update_user_group,
        name="update_user_group",
    ),
    url(
        r"^_internal/delete-user-group/(?P<group_id>[0-9]+)$",
        views.delete_user_group,
        name="delete_user_group",
    ),
    url(
        r"^_internal/restore-user-group/(?P<group_id>[0-9]+)$",
    ...
    url(
        r"^_internal/unshare-group-with-user/(?P<group_id>[0-9]+)/(?P<user_id>[0-9]+)/$",
        views.unshare_group_with_user,
        name="unshare_group_with_user",
    ),
    url(
        r"^_internal/make-group-membership-request/(?P<group_id>[0-9]+)/(?P<user_id>[0-9]+)/$",
        views.make_group_membership_request,
        name="make_group_membership_request",
    ),
    url(
        r"^_internal/make-group-membership-request/(?P<group_id>[0-9]+)/$",
        views.make_group_membership_request,
        name="make_group_membership_request",
    ),
    url(
    ...
    url(
        r"^_internal/create-resource/do/$",
