...
urlpatterns = patterns('',
    ...
    url(r'^resource/(?P<pk>[A-z0-9]+)/file_list/$',
    ...
    url(r'^_internal/(?P<shortkey>[A-z0-9]+)/(?P<element_name>[A-z]+)/add-metadata/$',
    ...
    url(r'^_internal/(?P<shortkey>[A-z0-9]+)/delete-resource-file/(?P<f>[0-9]+)/$',
        views.delete_file),
    url(r'^_internal/(?P<shortkey>[A-z0-9]+)/delete__multiple_files/$',
        views.delete__multiple_files),
    url(r'^_internal/(?P<shortkey>[A-z0-9]+)/delete-resource/$', views.delete_resource),
    url(r'^_internal/(?P<shortkey>[A-z0-9]+)/create-new-version-resource/$',
        views.create_new_version_resource),
    url(r'^_internal/(?P<shortkey>[A-z0-9]+)/rep-res-bag-to-irods-user-zone/$',
    ...
    url(r'^_internal/get-user-data/(?P<user_id>[0-9]+)$', views.get_user_data,
        name='get_user_data'),
