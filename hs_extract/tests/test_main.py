...
from hsextract.main import write_content_type_jsonld_metadata
from tests import read_s3_json, s3_path_exists, write_s3_json
...
def test_deletes_stale_jsonld_when_no_content_type_or_user_metadata():
    ...
    result = write_content_type_jsonld_metadata(md)
