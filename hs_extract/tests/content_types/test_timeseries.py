...
def test_resource_timeseries_csv_usermetadata():
    ...
    sleep(1)
    with open("tests/test_files/timeseries/ODM2_Multi_Site_One_Variable_Test.csv", "rb") as f:
        s3_client.upload_fileobj(f, "admin", f"{resource_id}/data/contents/ODM2_Multi_Site_One_Variable_Test.csv")

    result_netcdf_metadata = read_s3_json(f"admin/{resource_id}/.hsjsonld/ODM2_Multi_Site_One_Variable_Test.csv.json")
