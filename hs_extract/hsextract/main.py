...
def write_resource_jsonld_metadata(md: BaseMetadataObject, include_manifest: bool = True) -> bool:
    ...
    if include_manifest:
        ...
        combined_metadata["associatedMedia"] = _manifest_reference_list(md.resource_associated_media_jsonld_path)
...
def handle_minio_event(msg: redpanda_connect.Message) -> redpanda_connect.Message:
    ...
    if directory == ".hsmetadata":
        handle_root_resource_metadata_event(key, bucket, resource_id, file_updated)
        return
    else:
