...
try:
    ...
    cur1.execute('SELECT username, is_staff, is_active from auth_user')
    if cur1.rowcount > 0:
        rows = cur1.fetchall()
        for row in rows:
    ...
    cur1.execute('select auth_user.username, short_id, hs_core_title.value, public, frozen, do_not_distribute, '
                 ...
                 'where hs_core_genericresource.user_id=auth_user.id and hs_core_genericresource.object_id=hs_core_title.object_id '
    ...
    cur1.execute('select hs_core_genericresource.short_id, auth_user.username from hs_core_genericresource_owners, hs_core_genericresource, auth_user '
                 'where hs_core_genericresource_owners.genericresource_id=hs_core_genericresource.page_ptr_id and hs_core_genericresource_owners.user_id=auth_user.id')
    ...
    cur1.execute('select hs_core_genericresource.short_id, auth_user.username from hs_core_genericresource_edit_users, hs_core_genericresource, auth_user '
                 'where hs_core_genericresource_edit_users.genericresource_id=hs_core_genericresource.page_ptr_id and hs_core_genericresource_edit_users.user_id=auth_user.id')
    ...
    cur1.execute('select hs_core_genericresource.short_id, auth_user.username from hs_core_genericresource_view_users, hs_core_genericresource, auth_user '
                 'where hs_core_genericresource_view_users.genericresource_id=hs_core_genericresource.page_ptr_id and hs_core_genericresource_view_users.user_id=auth_user.id')
    ...
    cur1.execute('select auth_user.username, short_id, hs_core_title.value, public, frozen, do_not_distribute, '
                 ...
                 'where hs_geo_raster_resource_rasterresource.user_id=auth_user.id and hs_geo_raster_resource_rasterresource.object_id=hs_core_title.object_id '
    ...
    cur1.execute('select hs_geo_raster_resource_rasterresource.short_id, auth_user.username from hs_geo_raster_resource_rasterresource_owners, hs_geo_raster_resource_rasterresource, auth_user '
                 'where hs_geo_raster_resource_rasterresource_owners.rasterresource_id=hs_geo_raster_resource_rasterresource.page_ptr_id and hs_geo_raster_resource_rasterresource_owners.user_id=auth_user.id')
    ...
    cur1.execute('select hs_geo_raster_resource_rasterresource.short_id, auth_user.username from hs_geo_raster_resource_rasterresource_edit_users, hs_geo_raster_resource_rasterresource, auth_user '
                 'where hs_geo_raster_resource_rasterresource_edit_users.rasterresource_id=hs_geo_raster_resource_rasterresource.page_ptr_id and hs_geo_raster_resource_rasterresource_edit_users.user_id=auth_user.id')
    ...
    cur1.execute('select hs_geo_raster_resource_rasterresource.short_id, auth_user.username from hs_geo_raster_resource_rasterresource_view_users, hs_geo_raster_resource_rasterresource, auth_user '
                 'where hs_geo_raster_resource_rasterresource_view_users.rasterresource_id=hs_geo_raster_resource_rasterresource.page_ptr_id and hs_geo_raster_resource_rasterresource_view_users.user_id=auth_user.id')
    ...
    cur1.execute('select auth_user.username, short_id, hs_core_title.value, public, frozen, do_not_distribute, '
                 ...
                 'where ref_ts_reftimeseries.user_id=auth_user.id and ref_ts_reftimeseries.object_id=hs_core_title.object_id '
    ...
    cur1.execute('select ref_ts_reftimeseries.short_id, auth_user.username from ref_ts_reftimeseries_edit_users, ref_ts_reftimeseries, auth_user '
                 'where ref_ts_reftimeseries_edit_users.reftimeseries_id=ref_ts_reftimeseries.page_ptr_id and ref_ts_reftimeseries_edit_users.user_id=auth_user.id')
    ...
    cur1.execute('select ref_ts_reftimeseries.short_id, auth_user.username from ref_ts_reftimeseries_view_users, ref_ts_reftimeseries, auth_user '
                 'where ref_ts_reftimeseries_view_users.reftimeseries_id=ref_ts_reftimeseries.page_ptr_id and ref_ts_reftimeseries_view_users.user_id=auth_user.id')
