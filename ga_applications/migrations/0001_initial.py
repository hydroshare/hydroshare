...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ga_applications_application', (
            ...
            ('application_script', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
    ...
    models = {
        ...
        u'ga_applications.application': {
            ...
            'application_script': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
