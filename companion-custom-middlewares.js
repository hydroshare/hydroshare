...
// https://github.com/transloadit/uppy/blob/main/packages/%40uppy/companion/src/server/middlewares.js#L251
...
export const getCompanionMiddleware = (options) => {
   ...
   * @param {Function} next
   */
  console.log('Setting up custom companion middleware')
