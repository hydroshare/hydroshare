...
class RefTimeseriesFileTypeTest(
    ...
    def test_create_aggregation_1(self):
        ...
        self.assertEqual(
            logical_file.metadata.json_file_content.encode(),
    ...
    def test_res_metadata_on_create_aggregation(self):
        ...
        self.assertEqual(
            self.composite_resource.metadata.description.abstract, "Some abstract"
        )
    ...
    def test_create_aggregation_fail_with_empty_method_link(self):
        ...
        self._test_invalid_json_file(
            "refts_invalid_method_link_empty_string.refts.json"
        )
    ...
    def test_create_aggregation_fail_with_empty_method_description(self):
        ...
        self._test_invalid_json_file(
            "refts_invalid_method_description_empty_string.refts.json"
        )
    ...
    def test_create_aggregation_fail_with_empty_sample_medium(self):
        ...
        self._test_invalid_json_file(
            "refts_invalid_sample_medium_empty_string.refts.json"
        )
    ...
    def test_create_aggregation_fail_with_empty_file_version(self):
        ...
        self._test_invalid_json_file(
            "refts_invalid_fileversion_empty_string.refts.json"
        )
    ...
    def test_create_aggregation_fail_with_empty_variable_name(self):
        ...
        self._test_invalid_json_file(
            "refts_invalid_variable_name_empty_string.refts.json"
        )
    ...
    def test_main_file(self):
        ...
        self.assertEqual(
            ".json", RefTimeseriesLogicalFile.objects.first().get_main_file_type()
        )
        self.assertEqual(
            self.refts_file_name,
