...
class NetCDFFileTypeMetaDataTest(MockIRODSTestCaseMixin, TransactionTestCase):
    ...
    #     self.assertEqual(netcdf_logical_file.metadata.original_coverage.value['northlimit'], '121.345')
    #
    ...
    #                      'westlimit': '40.789', 'units': 'meters'}
    #     netcdf_logical_file.metadata.update_element(orig_coverage.id, value=coverage_data)
    #     self.assertEqual(netcdf_logical_file.metadata.original_coverage.value['northlimit'], '111.333')
    #
    ...
    #                      'shape': 'variable_shape'}
    #     netcdf_logical_file.metadata.update_element(variable.id, **variable_data)
