...
IRODS_PORT='1247'
IRODS_DEFAULT_RESOURCE='cuahsi1ReplResc'
IRODS_HOME_COLLECTION='/hydroshareZone/home/cuahsi1DataProxy'
IRODS_CWD='/hydroshareZone/home/cuahsi1DataProxy'
...
HS_USER_ZONE_PROXY_USER='cuahsi1LinuxProxy'
HS_USER_ZONE_PROXY_USER_PWD='aena3eijeiheir7iqu3mai7peun7aeRo'
HS_USER_ZONE_PROXY_USER_CREATE_USER_CMD='/home/cuahsi1LinuxProxy/create_user.sh'
HS_USER_ZONE_PROXY_USER_DELETE_USER_CMD='/home/cuahsi1LinuxProxy/delete_user.sh'

# the local HydroShare proxy user (a counterpart of wwwHydroProxy) in a federated zone with HydroShare Zone
HS_LOCAL_PROXY_USER_IN_FED_ZONE='cuahsi1UserProxy'
# HS_LOCAL_PROXY_USER_IN_FED_ZONE_AUTH='yiegh3reeheiziexoo4oo9uum3Haex7w'

# Please keep the line below unchanged since it is used to check whether
# the current site is in production or not
HS_WWW_IRODS_PROXY_USER='cuahsi1DataProxy'
...
HS_IRODS_LOCAL_ZONE_DEF_RES='cuahsi1LocalResc'
