...
# hsuserproxy system user configuration used to create xDCIShare iRODS users on-demand
HS_USER_ZONE_HOST = ''
...
# the local xDCIShare proxy user (a counterpart of wwwHydroProxy) in a federated zone with HydroShare Zone
