...
urlpatterns = i18n_patterns(
    ...
    url(r'^communities/manage-requests/$', hs_communities.views.communities.CommunityCreationRequests.as_view(),
        name='manage_requests'),
    url(r'^communities/manage-requests/(?P<rid>[0-9]+)/$',
      hs_communities.views.communities.CommunityCreationRequest.as_view(), name='manage_request'),
