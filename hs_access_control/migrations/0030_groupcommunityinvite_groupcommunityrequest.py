# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2021-06-04 11:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('community_owner', models.ForeignKey(default=None, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invite_gcc', to=settings.AUTH_USER_MODEL)),
                ('group', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='auth.Group')),
                ('group_owner', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invite_gcg', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
