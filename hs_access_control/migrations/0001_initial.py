    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        related_name="group2resource",
                        editable=False,
                        through="hs_access_control.GroupResourcePrivilege",
                        to="hs_access_control.GroupAccess",
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="whether user is currently capable of action",
                        editable=False,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="whether user is an administrator",
                        editable=False,
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        editable=False,
                        on_delete=models.CASCADE,
                        to="hs_access_control.UserAccess",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        editable=False,
                        on_delete=models.CASCADE,
                        to="hs_access_control.ResourceAccess",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                related_name="group2user",
                editable=False,
                through="hs_access_control.UserGroupPrivilege",
                to="hs_access_control.GroupAccess",
            ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                related_name="resource2user",
                editable=False,
                through="hs_access_control.UserResourcePrivilege",
                to="hs_access_control.ResourceAccess",
            ),
            preserve_default=True,
        ),
