...
class GroupCommunityInvite(models.Model):
    ...
    def create_or_update(cls, privilege=PrivilegeCodes.VIEW, **kwargs):
        ...
        assert(community_owner.uaccess.owns_community(community))
        ...
        # auto-approve if auto_approve is True
            ...
            invite_record.act(community_owner=community.first_owner, approved=True)
    ...
    def act(self, group_owner, approved=False):
        ...
        assert(group_owner.uaccess.owns_group(self.group))
        assert(community_owner.uaccess.owns_community(self.community))
        if approved:
