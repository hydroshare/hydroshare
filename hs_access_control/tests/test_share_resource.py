...
from hs_access_control.tests.utilities import (
    global_reset,
    is_equal_to_as_set,
    assertUserResourceUnshareCoherence,
    assertUserGroupUnshareCoherence,
)
...
class T05ShareResource(MockIRODSTestCaseMixin, TestCase):
    ...
    def test_01_resource_unshared_state(self):
        ...
        self.assertEqual(
            1, UserResourcePrivilege.objects.filter(user=cat, resource=holes).count()
        )
        ...
        self.assertTrue(
            is_equal_to_as_set([], cat.uaccess.get_resource_unshare_users(holes))
        )
        self.assertTrue(
            is_equal_to_as_set([], cat.uaccess.get_resource_unshare_groups(holes))
        )
        ...
        self.assertEqual(
            0, UserResourcePrivilege.objects.filter(user=dog, resource=holes).count()
        )
    ...
    def test_02_share_resource_ownership(self):
        ...
        self.assertTrue(
            cat.uaccess.can_share_resource_with_user(holes, dog, PrivilegeCodes.OWNER)
        )
        ...
        self.assertTrue(
            is_equal_to_as_set([dog], cat.uaccess.get_resource_unshare_users(holes))
        )
        self.assertTrue(
            is_equal_to_as_set([], cat.uaccess.get_resource_unshare_groups(holes))
        )
        ...
        self.assertEqual(
            1, UserResourcePrivilege.objects.filter(user=dog, resource=holes).count()
        )
        self.assertEqual(
            cat, UserResourcePrivilege.objects.get(user=dog, resource=holes).grantor
        )
    ...
    def test_03_share_resource_rw(self):
        ...
        self.assertTrue(
            cat.uaccess.can_share_resource_with_user(holes, dog, PrivilegeCodes.CHANGE)
        )
    ...
    def test_04_share_resource_ro(self):
        ...
        self.assertTrue(
            cat.uaccess.can_share_resource_with_user(holes, dog, PrivilegeCodes.VIEW)
        )
    ...
    def test_05_share_resource_downgrade_privilege(self):
        ...
        self.assertTrue(self.cat.uaccess.can_unshare_resource_with_user(holes, dog))
        ...
        self.assertEqual(
            self.holes.raccess.get_effective_privilege(self.mouse),
        ...
        self.cat.uaccess.share_resource_with_user(holes, dog, PrivilegeCodes.CHANGE)
        self.assertEqual(
            self.holes.raccess.get_effective_privilege(self.dog), PrivilegeCodes.CHANGE
        )
        ...
        self.cat.uaccess.unshare_resource_with_user(holes, dog)
        self.assertEqual(
            self.holes.raccess.get_effective_privilege(self.dog), PrivilegeCodes.NONE
        )
    ...
    def test_07_share_group_ownership(self):
        ...
        self.assertTrue(
            cat.uaccess.can_share_group_with_user(meowers, dog, PrivilegeCodes.OWNER)
        )
    ...
    def test_08_share_group_rw(self):
        ...
        self.assertTrue(
            is_equal_to_as_set([], cat.uaccess.get_group_unshare_users(meowers))
        )
        ...
        self.assertTrue(
            cat.uaccess.can_share_group_with_user(meowers, dog, PrivilegeCodes.CHANGE)
        )
        ...
        self.assertTrue(
            is_equal_to_as_set([dog], cat.uaccess.get_group_unshare_users(meowers))
        )
    ...
    def test_09_share_group_ro(self):
        ...
        self.assertTrue(
            cat.uaccess.can_share_group_with_user(meowers, dog, PrivilegeCodes.VIEW)
        )
    ...
    def test_11_resource_sharing_with_group(self):
        ...
        self.assertTrue(
            is_equal_to_as_set([dog], dog.uaccess.get_resource_unshare_users(holes))
        )
    ...
    def test_13_self_reduction_of_privilege(self):
        ...
        self.assertTrue(
            dog.uaccess.can_share_resource_with_user(holes, dog, PrivilegeCodes.VIEW)
        )
    ...
    def test_14_non_idempotence_of_unprivileged_share(self):
        ...
        cat.uaccess.share_resource_with_user(holes, dog, PrivilegeCodes.VIEW)
        self.assertTrue(
            dog.uaccess.can_share_resource_with_user(holes, mouse, PrivilegeCodes.VIEW)
        )
        ...
        cat.uaccess.share_group_with_user(meowers, dog, PrivilegeCodes.CHANGE)
        self.assertTrue(
            dog.uaccess.can_share_group_with_user(meowers, mouse, PrivilegeCodes.VIEW)
        )
        ...
        cat.uaccess.share_group_with_user(meowers, dog, PrivilegeCodes.CHANGE)
        self.assertTrue(
            dog.uaccess.can_share_group_with_user(meowers, mouse, PrivilegeCodes.CHANGE)
        )
