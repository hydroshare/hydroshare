...
class TestRequest(TestCase):
    ...
    def test_community_invite_group_to_community(self):
        ...
        request = GroupCommunityRequest.get_request(
            community=self.pets, group=self.cats
        )

        expected = "Request created to connect group '{}' to community '{}'.".format(
    ...
    def test_auto_approve(self):
        ...
        expected = (
            "Request auto-approved to connect group '{}' to community '{}'.".format(
                self.cats.name, self.pets.name
            )
        )
    ...
    def test_group_request_owns_both(self):
        ...
        expected = (
            "Request approved to connect group '{}' to community '{}'"
            " because you own both.".format(self.cats.name, self.pets.name)
        )
    ...
    def test_community_invite_update(self):
        ...
        expected = "Request updated: connect group '{}' to community '{}'.".format(
            self.cats.name, self.pets.name
        )
