...
class UnitTests(MockIRODSTestCaseMixin, TestCase):
    ...
    def test_user_can_share_group_with_user(self):
        ...
        bikers = self.bikers
        self.assertTrue(
            george.uaccess.can_share_group_with_user(bikers, alva, PrivilegeCodes.VIEW)
        )
        self.assertFalse(
            alva.uaccess.can_share_group_with_user(bikers, george, PrivilegeCodes.VIEW)
        )
    ...
    def test_user_get_group_unshare_users(self):
        ...
        george.uaccess.share_group_with_user(bikers, alva, PrivilegeCodes.VIEW)
        self.assertTrue(
            is_equal_to_as_set(george.uaccess.get_group_unshare_users(bikers), [alva])
        )
    ...
    def test_user_view_resources(self):
        ...
        self.assertTrue(
            is_equal_to_as_set(george.uaccess.view_resources, [bikes, trikes])
        )
    ...
    def test_user_owned_resources(self):
        ...
        self.assertTrue(
            is_equal_to_as_set(george.uaccess.owned_resources, [bikes, trikes])
        )
    ...
    def test_user_get_resources_with_explicit_access(self):
        ...
        self.assertTrue(
            is_equal_to_as_set(
                george.uaccess.get_resources_with_explicit_access(PrivilegeCodes.OWNER),
                [bikes],
            )
        )
        self.assertTrue(
    ...
    def test_user_get_groups_with_explicit_access(self):
        ...
        self.assertTrue(
            is_equal_to_as_set(
                george.uaccess.get_groups_with_explicit_access(PrivilegeCodes.OWNER),
                [bikers],
            )
        )
        self.assertTrue(
    ...
    def test_user_get_resource_unshare_users(self):
        ...
        bikes = self.bikes
        self.assertTrue(
            is_equal_to_as_set(george.uaccess.get_resource_unshare_users(bikes), [])
        )
        george.uaccess.share_resource_with_user(bikes, alva, PrivilegeCodes.VIEW)
        self.assertTrue(
            is_equal_to_as_set(george.uaccess.get_resource_unshare_users(bikes), [alva])
        )
    ...
    def test_user_get_resource_unshare_groups(self):
        ...
        bikers = self.bikers
        self.assertTrue(
            is_equal_to_as_set(george.uaccess.get_resource_unshare_groups(bikes), [])
        )
        george.uaccess.share_resource_with_group(bikes, bikers, PrivilegeCodes.VIEW)
        self.assertTrue(
            is_equal_to_as_set(
                george.uaccess.get_resource_unshare_groups(bikes), [bikers]
            )
        )
    ...
    def test_group_get_resources_with_explicit_access(self):
        ...
        self.assertTrue(
            is_equal_to_as_set(
                bikers.gaccess.get_resources_with_explicit_access(PrivilegeCodes.VIEW),
                [],
            )
        )
        george.uaccess.share_resource_with_group(bikes, bikers, PrivilegeCodes.CHANGE)
    ...
    def test_group_get_effective_privilege(self):
        ...
        bikers = self.bikers
        self.assertEqual(
            bikers.gaccess.get_effective_privilege(george), PrivilegeCodes.OWNER
        )
        self.assertEqual(
            bikers.gaccess.get_effective_privilege(alva), PrivilegeCodes.NONE
        )
    ...
    def test_resource_get_effective_user_privilege(self):
        ...
        bikes = self.bikes
        self.assertEqual(
            bikes.raccess.get_effective_user_privilege(george), PrivilegeCodes.OWNER
        )
        self.assertEqual(
            bikes.raccess.get_effective_user_privilege(alva), PrivilegeCodes.NONE
        )
    ...
    def test_resource_get_effective_group_privilege(self):
        ...
        george.uaccess.share_resource_with_group(bikes, bikers, PrivilegeCodes.CHANGE)
        self.assertEqual(
            bikes.raccess.get_effective_group_privilege(alva), PrivilegeCodes.NONE
        )
        george.uaccess.share_group_with_user(bikers, alva, PrivilegeCodes.VIEW)
        self.assertEqual(
            bikes.raccess.get_effective_group_privilege(alva), PrivilegeCodes.CHANGE
        )
    ...
    def test_resource_get_effective_privilege(self):
        ...
        bikes = self.bikes
        self.assertEqual(
            bikes.raccess.get_effective_privilege(george), PrivilegeCodes.OWNER
        )
        self.assertEqual(
