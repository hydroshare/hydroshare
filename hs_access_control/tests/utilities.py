...
def assertResourceOwnersAre(self, this_resource, these_users):
    ...
    for u in these_users:
        ...
        self.assertTrue(
            this_resource
            in u.uaccess.get_resources_with_explicit_access(PrivilegeCodes.OWNER)
        )
        self.assertTrue(
            this_resource
            not in u.uaccess.get_resources_with_explicit_access(PrivilegeCodes.CHANGE)
        )
        self.assertTrue(
            this_resource
            not in u.uaccess.get_resources_with_explicit_access(PrivilegeCodes.VIEW)
        )
        ...
        self.assertEqual(
            this_resource.raccess.get_effective_privilege(u), PrivilegeCodes.OWNER
        )
...
def assertResourceEditorsAre(self, this_resource, these_users):
    ...
    if not this_resource.raccess.immutable:
        ...
        self.assertTrue(
            is_equal_to_as_set(
                this_resource.raccess.edit_users, this_resource.raccess.owners
            )
        )
    self.assertTrue(is_subset_of(these_users, this_resource.raccess.edit_users))
    for u in these_users:
        ...
        self.assertTrue(
            is_equal_to_as_set(
                set(u.uaccess.edit_resources) - set(u.uaccess.owned_resources),
        ...
        self.assertTrue(
            this_resource
            not in u.uaccess.get_resources_with_explicit_access(PrivilegeCodes.OWNER)
        )
        self.assertTrue(
            this_resource
            in u.uaccess.get_resources_with_explicit_access(PrivilegeCodes.CHANGE)
        )
        self.assertTrue(
            this_resource
            not in u.uaccess.get_resources_with_explicit_access(PrivilegeCodes.VIEW)
        ...
        self.assertTrue(u in this_resource.raccess.edit_users)
        self.assertEqual(
            this_resource.raccess.get_effective_privilege(u), PrivilegeCodes.CHANGE
        )
...
def assertResourceViewersAre(self, this_resource, these_users):
    ...
    for u in these_users:
        ...
        self.assertTrue(
            this_resource
            in u.uaccess.get_resources_with_explicit_access(PrivilegeCodes.VIEW)
        )
        self.assertTrue(u in this_resource.raccess.view_users)
        self.assertTrue(u not in this_resource.raccess.owners)
        self.assertTrue(u not in this_resource.raccess.edit_users)
        self.assertEqual(
            this_resource.raccess.get_effective_privilege(u), PrivilegeCodes.VIEW
        )
...
def assertResourceUserState(self, this_resource, owners, editors, viewers):
    ...
    self.assertTrue(
        is_equal_to_as_set(
            this_resource.raccess.view_users, set(owners) | set(editors) | set(viewers)
        )
    )
...
def assertOwnedResourcesAre(self, this_user, these_resources):
    ...
    self.assertTrue(
        is_equal_to_as_set(this_user.uaccess.owned_resources, these_resources)
    )
    self.assertTrue(is_subset_of(these_resources, this_user.uaccess.view_resources))
    self.assertTrue(
        is_equal_to_as_set(
            these_resources,
            this_user.uaccess.get_resources_with_explicit_access(PrivilegeCodes.OWNER),
        )
    )
    self.assertTrue(
        is_disjoint_from(
            these_resources,
            this_user.uaccess.get_resources_with_explicit_access(PrivilegeCodes.CHANGE),
        )
    )
    self.assertTrue(
        is_disjoint_from(
            these_resources,
            this_user.uaccess.get_resources_with_explicit_access(PrivilegeCodes.VIEW),
        )
    )
    for r in these_resources:
        ...
        self.assertEqual(
            r.raccess.get_effective_privilege(this_user), PrivilegeCodes.OWNER
        )
...
def assertEditableResourcesAre(self, this_user, these_resources):
    """this user owns these resources"""
    self.assertTrue(
        is_disjoint_from(this_user.uaccess.owned_resources, these_resources)
    )
    self.assertTrue(is_subset_of(these_resources, this_user.uaccess.view_resources))
    self.assertTrue(
        is_disjoint_from(
    ...
    for r in these_resources:
        ...
        self.assertTrue(r in this_user.uaccess.edit_resources)
        self.assertEqual(
            r.raccess.get_effective_privilege(this_user), PrivilegeCodes.CHANGE
        )
...
def assertViewableResourcesAre(self, this_user, these_resources):
    """this user owns these resources"""
    self.assertTrue(
        is_disjoint_from(these_resources, this_user.uaccess.owned_resources)
    )
    ...
    for r in these_resources:
        ...
        self.assertTrue(this_user in r.raccess.view_users)
        self.assertEqual(
            r.raccess.get_effective_privilege(this_user), PrivilegeCodes.VIEW
        )
...
def assertGroupOwnersAre(self, this_group, these_users):
    ...
    self.assertTrue(
        is_disjoint_from(
            these_users,
            set(this_group.gaccess.edit_users) - set(this_group.gaccess.owners),
        )
    )
    self.assertTrue(
        is_disjoint_from(
            these_users,
            set(this_group.gaccess.members) - set(this_group.gaccess.owners),
        )
    )
    for u in these_users:
        ...
        self.assertTrue(
            this_group
            in u.uaccess.get_groups_with_explicit_access(PrivilegeCodes.OWNER)
        )
        self.assertTrue(
            this_group
            not in u.uaccess.get_groups_with_explicit_access(PrivilegeCodes.CHANGE)
        )
        self.assertTrue(
            this_group
            not in u.uaccess.get_groups_with_explicit_access(PrivilegeCodes.VIEW)
        )
        self.assertEqual(
            this_group.gaccess.get_effective_privilege(u), PrivilegeCodes.OWNER
        )
...
def assertGroupEditorsAre(self, this_group, these_users):
    ...
    self.assertTrue(
        is_disjoint_from(
            these_users,
            set(this_group.gaccess.members) - set(this_group.gaccess.edit_users),
        )
    )
    for u in these_users:
        ...
        self.assertTrue(
            this_group
            not in u.uaccess.get_groups_with_explicit_access(PrivilegeCodes.OWNER)
        )
        self.assertTrue(
            this_group
            in u.uaccess.get_groups_with_explicit_access(PrivilegeCodes.CHANGE)
        )
        self.assertTrue(
            this_group
            not in u.uaccess.get_groups_with_explicit_access(PrivilegeCodes.VIEW)
        ...
        self.assertEqual(
            this_group.gaccess.get_effective_privilege(u), PrivilegeCodes.CHANGE
        )
...
def assertGroupViewersAre(self, this_group, these_users):
    ...
    for u in these_users:
        ...
        self.assertTrue(
            this_group in u.uaccess.get_groups_with_explicit_access(PrivilegeCodes.VIEW)
        )
        self.assertEqual(
            this_group.gaccess.get_effective_privilege(u), PrivilegeCodes.VIEW
        )
...
def assertGroupUserState(self, this_group, owners, editors, viewers):
    ...
    self.assertTrue(
        is_equal_to_as_set(
            this_group.gaccess.members, set(owners) | set(editors) | set(viewers)
        )
    )
    self.assertTrue(
        is_equal_to_as_set(this_group.gaccess.edit_users, set(owners) | set(editors))
    )
...
def assertOwnedGroupsAre(self, this_user, these_groups):
    ...
    self.assertTrue(
        is_disjoint_from(
            these_groups,
            set(this_user.uaccess.edit_groups) - set(this_user.uaccess.owned_groups),
        )
    )
    self.assertTrue(
        is_disjoint_from(
            these_groups,
            set(this_user.uaccess.view_groups) - set(this_user.uaccess.owned_groups),
        )
    )
    self.assertTrue(
        is_equal_to_as_set(
            these_groups,
            this_user.uaccess.get_groups_with_explicit_access(PrivilegeCodes.OWNER),
        )
    )
    self.assertTrue(
        is_disjoint_from(
            these_groups,
            this_user.uaccess.get_groups_with_explicit_access(PrivilegeCodes.CHANGE),
        )
    )
    self.assertTrue(
        is_disjoint_from(
            these_groups,
            this_user.uaccess.get_groups_with_explicit_access(PrivilegeCodes.VIEW),
        )
    )
    for g in these_groups:
        ...
        self.assertEqual(
            g.gaccess.get_effective_privilege(this_user), PrivilegeCodes.OWNER
        )
...
def assertEditableGroupsAre(self, this_user, these_groups):
    ...
    for g in these_groups:
        ...
        self.assertEqual(
            g.gaccess.get_effective_privilege(this_user), PrivilegeCodes.CHANGE
        )
...
def assertViewableGroupsAre(self, this_user, these_groups):
    ...
    self.assertTrue(
        is_disjoint_from(
            these_groups,
            set(this_user.uaccess.edit_groups) - set(this_user.uaccess.view_groups),
        )
    )
    self.assertTrue(
        is_disjoint_from(
    ...
    for g in these_groups:
        ...
        self.assertFalse(this_user.uaccess.can_delete_group(g))
        self.assertEqual(
            g.gaccess.get_effective_privilege(this_user), PrivilegeCodes.VIEW
        )
...
def assertUserGroupState(self, this_user, owned, editable, viewable):
    ...
    self.assertTrue(
        is_equal_to_as_set(
            this_user.uaccess.view_groups, set(owned) | set(editable) | set(viewable)
        )
    )
...
def assertResourceGroupEditorsAre(self, this_resource, these_groups):
    ...
    for g in these_groups:
        ...
        self.assertTrue(
            this_resource
            not in g.gaccess.get_resources_with_explicit_access(PrivilegeCodes.OWNER)
        )
        self.assertTrue(
            this_resource
            in g.gaccess.get_resources_with_explicit_access(PrivilegeCodes.CHANGE)
        )
        self.assertTrue(
            this_resource
            not in g.gaccess.get_resources_with_explicit_access(PrivilegeCodes.VIEW)
        )
...
def assertResourceGroupViewersAre(self, this_resource, these_groups):
    ...
    for g in these_groups:
        ...
        self.assertTrue(
            this_resource
            not in g.gaccess.get_resources_with_explicit_access(PrivilegeCodes.CHANGE)
        )
        self.assertTrue(
            this_resource
            in g.gaccess.get_resources_with_explicit_access(PrivilegeCodes.VIEW)
        )
...
def assertResourceGroupState(self, this_resource, editors, viewers):
    ...
    self.assertTrue(
        is_equal_to_as_set(
            this_resource.raccess.view_groups, set(editors) | set(viewers)
        )
    )
...
def assertGroupEditableResourcesAre(self, this_group, these_resources):
    ...
    self.assertTrue(
        is_disjoint_from(
            these_resources,
            this_group.gaccess.get_resources_with_explicit_access(PrivilegeCodes.VIEW),
        )
    )
    self.assertTrue(
        is_equal_to_as_set(these_resources, this_group.gaccess.edit_resources)
    )
    for r in these_resources:
...
def assertGroupViewableResourcesAre(self, this_group, these_resources):
    ...
    self.assertTrue(
        is_disjoint_from(these_resources, this_group.gaccess.edit_resources)
    )
    for r in these_resources:
...
def assertGroupResourceState(self, this_group, editable, viewable):
    ...
    self.assertTrue(
        is_equal_to_as_set(
            this_group.gaccess.view_resources, set(editable) | set(viewable)
        )
    )
...
def getUserGroupState(this_user):
    return {
        ...
        "CHANGE": this_user.uaccess.get_groups_with_explicit_access(
            PrivilegeCodes.CHANGE
        ),
...
def assertUserGroupUnshareCoherence(self):
    ...
    for g in Group.objects.all().exclude(
        pk=self.group.pk
    ):  # all groups except Hydroshare Author
        for u in User.objects.all():  # all instigating users
            for v in User.objects.all():  # all target users
...
def printUserGroupProvenance():
    ...
    prov = UserGroupProvenance.objects.all().order_by("user__id", "group__id", "start")
    o = None
    for p in prov:
        if o is not None and (p.user != o.user or p.group != o.group):
            print("------------------------------")
        current = UserGroupProvenance.get_current_record(group=p.group, user=p.user)
        star = ""
        if current == p:
            star = "CURRENT"
        print((p, star))
