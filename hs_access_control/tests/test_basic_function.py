...
from hs_access_control.tests.utilities import (
    ...
    assertUserGroupState,
    assertGroupUserState,
    assertGroupResourceState,
    assertResourceGroupState,
)
...
class BasicFunction(MockIRODSTestCaseMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.bikers = self.george.uaccess.create_group(
            title="Bikers", description="We are the bikers"
        )

        # george creates a group 'harpers'
        self.harpers = self.george.uaccess.create_group(
            title="Harpers", description="We are the harpers"
        )
    ...
    def test_share(self):
        ...
        self.assertEqual(
            bikes.raccess.get_effective_privilege(admin), PrivilegeCodes.OWNER
        )
    ...
    def test_share_inactive_user(self):
        ...
        self.assertEqual(
            bikes.raccess.get_effective_privilege(john), PrivilegeCodes.CHANGE
        )
