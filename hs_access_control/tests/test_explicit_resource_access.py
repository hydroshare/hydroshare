...
class TestExplicitResourceAccess(MockIRODSTestCaseMixin, TestCase):
    def setUp(self):
        ...
        self.group_test = self.user_A.uaccess.create_group(
            title="Test Group", description="This group is all about testing"
        )
    ...
    def test_explicit_resource_access(self):
        ...
        users = self.resource.raccess.get_users_with_explicit_access(
        ...
        self.user_A.uaccess.share_group_with_user(
            self.group_test, self.user_C, PrivilegeCodes.VIEW
        )
        ...
        self.user_A.uaccess.share_group_with_user(
            self.group_test, self.user_C, PrivilegeCodes.CHANGE
        )
