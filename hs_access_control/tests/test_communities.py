...
class TestCommunities(MockIRODSTestCaseMixin, TestCase):
    def setUp(self):
        ...
        self.dog.uaccess.share_group_with_user(
            self.dogs, self.dog2, PrivilegeCodes.VIEW
        )
        ...
        self.cat.uaccess.share_group_with_user(
            self.cats, self.cat2, PrivilegeCodes.VIEW
        )
        ...
        self.bat.uaccess.share_group_with_user(
            self.bats, self.bat2, PrivilegeCodes.VIEW
        )
        ...
        self.bat.uaccess.share_group_with_user(
            self.bats, self.dog, PrivilegeCodes.OWNER
        )
        ...
        self.dog.uaccess.share_resource_with_group(
            self.holes, self.dogs, PrivilegeCodes.VIEW
        )
        ...
        self.cat.uaccess.share_resource_with_group(
            self.claus, self.cats, PrivilegeCodes.CHANGE
        )
        ...
        self.bat.uaccess.share_resource_with_group(
            self.wings, self.bats, PrivilegeCodes.VIEW
        )
        ...
        self.pests = self.bat.uaccess.create_community(
            "all kinds of pests", "collaboration on how to be a more effective pest."
        )
    ...
    def test_share_community_with_group(self):
        ...
        self.assertTrue(
            self.dog.uaccess.can_share_community_with_group(
                self.pets, self.dogs, PrivilegeCodes.VIEW
            )
        )
        self.assertFalse(
            self.dog.uaccess.can_share_community_with_group(
                self.pets, self.dogs, PrivilegeCodes.CHANGE
            )
        )
        self.assertTrue(
            self.dog.uaccess.can_share_community_with_group(
        ...
        self.assertFalse(
            self.dog.uaccess.can_share_community_with_group(
                self.pets, self.cats, PrivilegeCodes.CHANGE
            )
        )
        ...
        self.assertEqual(
            self.pets.get_effective_group_privilege(self.dogs), PrivilegeCodes.VIEW
        )
        self.assertEqual(
            self.pets.get_effective_group_privilege(self.cats), PrivilegeCodes.VIEW
        )
        ...
        self.assertFalse(
            self.dog.uaccess.can_share_community_with_group(
                self.pets, self.dogs, PrivilegeCodes.OWNER
            )
        )
        ...
        self.assertTrue(
            self.dog.uaccess.can_unshare_community_with_group(self.pets, self.dogs)
        )
        self.dog.uaccess.unshare_community_with_group(self.pets, self.dogs)

        self.assertEqual(
            self.pets.get_effective_group_privilege(self.dogs), PrivilegeCodes.NONE
        )
        self.assertEqual(
            self.pets.get_effective_group_privilege(self.cats), PrivilegeCodes.VIEW
        )
    ...
    def test_undo_share_community_with_group(self):
        ...
        self.assertTrue(
            self.dog.uaccess.can_undo_share_community_with_group(self.pets, self.dogs)
        )
    ...
    def test_share_community_with_user(self):
        ...
        # first check permissions
        self.assertTrue(
            self.dog.uaccess.can_share_community_with_user(
                self.pets, self.dog2, PrivilegeCodes.VIEW
            )
        )
        self.assertTrue(
            self.dog.uaccess.can_share_community_with_user(
                self.pets, self.dog2, PrivilegeCodes.CHANGE
            )
        )
        self.assertTrue(
            self.dog.uaccess.can_share_community_with_user(
                self.pets, self.cat2, PrivilegeCodes.VIEW
            )
        )
        self.assertTrue(
            self.dog.uaccess.can_share_community_with_user(
                self.pets, self.cat2, PrivilegeCodes.CHANGE
            )
        )
        ...
        self.assertEqual(
            self.pets.get_effective_user_privilege(self.dog2), PrivilegeCodes.VIEW
        )
        self.assertEqual(
            self.pets.get_effective_user_privilege(self.cat2), PrivilegeCodes.VIEW
        )
        ...
        self.assertTrue(
            self.dog.uaccess.can_share_community_with_user(
                self.pets, self.dog2, PrivilegeCodes.OWNER
            )
        )
        self.dog.uaccess.share_community_with_user(
            self.pets, self.dog2, PrivilegeCodes.OWNER
        ...
        # provenance object created
        ggp = UserCommunityProvenance.objects.filter(
            user=self.dog2, community=self.pets
        )
        self.assertEqual(ggp.count(), 2)

        # Privileges are changed by the previous act
        self.assertEqual(
            self.pets.get_effective_user_privilege(self.dog2), PrivilegeCodes.OWNER
        )
        self.assertEqual(
            self.pets.get_effective_user_privilege(self.cat2), PrivilegeCodes.VIEW
        )
        ...
        self.assertEqual(
            self.pets.get_effective_user_privilege(self.dog2), PrivilegeCodes.CHANGE
        )
        self.assertEqual(
            self.pets.get_effective_user_privilege(self.cat2), PrivilegeCodes.VIEW
        )
        ...
        self.assertTrue(
            self.dog.uaccess.can_unshare_community_with_user(self.pets, self.dog2)
        )
        self.dog.uaccess.unshare_community_with_user(self.pets, self.dog2)

        self.assertEqual(
            self.pets.get_effective_user_privilege(self.dog2), PrivilegeCodes.NONE
        )
        self.assertEqual(
            self.pets.get_effective_user_privilege(self.cat2), PrivilegeCodes.VIEW
        )
    ...
    def test_undo_share_community_with_user(self):
        ...
        self.assertTrue(
            self.dog.uaccess.can_undo_share_community_with_user(self.pets, self.dog2)
        )
    ...
    def test_explanations(self):
        ...
        self.dog.uaccess.share_community_with_group(
            self.pets, self.bats, PrivilegeCodes.VIEW
        )
        self.dog.uaccess.share_community_with_group(
            self.pets, self.cats, PrivilegeCodes.VIEW
        )
    ...
    def test_iteration(self):
        ...
        for group in groupv:
            ...
            for r in view_resources:
                ...
                if (
                    not self.dog.uaccess.owns_resource(r)
                    and not GroupResourcePrivilege.objects.filter(
                        resource=r,
                        privilege=PrivilegeCodes.CHANGE,
                        group__g2ugp__user=self.dog,
                    ).exists()
                ):
    ...
    def test_share_resource_with_community(self):
        ...
        self.assertTrue(
            self.dog.uaccess.can_share_resource_with_community(
                self.pets, self.holes, PrivilegeCodes.VIEW
            )
        )
        self.assertFalse(
            self.dog.uaccess.can_share_resource_with_community(
                self.pets, self.holes, PrivilegeCodes.CHANGE
            )
        )

        self.dog.uaccess.share_resource_with_community(
            self.pets, self.holes, PrivilegeCodes.VIEW
        )
        ...
        ggp = UserCommunityPrivilege.objects.get(user=self.dog, community=self.pets)
        self.assertEqual(ggp.privilege, PrivilegeCodes.OWNER)
        ggp = CommunityResourcePrivilege.objects.get(
            resource=self.holes, community=self.pets
        )
        self.assertEqual(ggp.privilege, PrivilegeCodes.VIEW)
        ...
        ggp = UserCommunityProvenance.objects.get(user=self.dog, community=self.pets)
        self.assertEqual(ggp.privilege, PrivilegeCodes.OWNER)
        ggp = CommunityResourceProvenance.objects.get(
            resource=self.holes, community=self.pets
        )
        self.assertEqual(ggp.privilege, PrivilegeCodes.VIEW)

        self.assertEqual(
            self.pets.get_effective_resource_privilege(self.holes), PrivilegeCodes.VIEW
        )
        ...
        self.assertFalse(
            self.dog.uaccess.can_share_resource_with_community(
                self.pets, self.holes, PrivilegeCodes.OWNER
            )
        )
        with self.assertRaises(PermissionDenied):
            self.dog.uaccess.share_resource_with_community(
        ...
        self.assertTrue(
            self.dog.uaccess.can_unshare_resource_with_community(self.pets, self.holes)
        )
        self.dog.uaccess.unshare_resource_with_community(self.pets, self.holes)

        self.assertEqual(
            self.pets.get_effective_resource_privilege(self.holes), PrivilegeCodes.NONE
        )
    ...
    def test_undo_share_resource_with_community(self):
        ...
        self.assertTrue(
            self.dog.uaccess.can_undo_share_resource_with_community(
                self.pets, self.holes
            )
        )
