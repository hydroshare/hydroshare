...
S3_PROXY_POOL_MAX_CONNECTIONS=50
S3_PROXY_POOL_MAX_KEEPALIVE_CONNECTIONS=20
...
gcloud run deploy ${SERVICE_NAME} \
  ...
  --set-env-vars "S3_PROXY_POOL_MAX_CONNECTIONS=${S3_PROXY_POOL_MAX_CONNECTIONS}" \
  --set-env-vars "S3_PROXY_POOL_MAX_KEEPALIVE_CONNECTIONS=${S3_PROXY_POOL_MAX_KEEPALIVE_CONNECTIONS}" \
