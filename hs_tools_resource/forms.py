...
class UrlBaseForm(ModelForm):
    def __init__(
        ...
        self.helper = UrlBaseFormHelper(
            allow_edit, res_short_id, element_id, element_name="RequestUrlBase"
        )
...
class UrlBaseAggregationFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(UrlBaseAggregationFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class UrlBaseAggregationForm(ModelForm):
    def __init__(
        ...
        self.helper = UrlBaseAggregationFormHelper(
            allow_edit,
            res_short_id,
            element_id,
...
class UrlBaseFileFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(UrlBaseFileFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class UrlBaseFileForm(ModelForm):
    def __init__(
        ...
        self.helper = UrlBaseFileFormHelper(
            allow_edit, res_short_id, element_id, element_name="RequestUrlBaseFile"
        )
        self.fields["value"].label = ""
        ...
        for val in val_array:
            if not val.strip().startswith("."):
                raise ValidationError(
                    "File extensions must be begin with a period and be comma "
...
class SupportedFileExtensionsFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(SupportedFileExtensionsFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class SupportedFileExtensionsForm(ModelForm):
    def __init__(
        ...
        self.helper = SupportedFileExtensionsFormHelper(
            allow_edit, res_short_id, element_id, element_name="SupportedFileExtensions"
        )
        self.fields["value"].label = ""
...
class AppHomePageUrlFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(AppHomePageUrlFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class AppHomePageUrlForm(ModelForm):
    def __init__(
        ...
        self.helper = AppHomePageUrlFormHelper(
            allow_edit, res_short_id, element_id, element_name="AppHomePageUrl"
        )
        self.fields["value"].label = ""
...
class TestingProtocolUrlFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(TestingProtocolUrlFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class TestingProtocolUrlForm(ModelForm):
    def __init__(
        ...
        self.helper = TestingProtocolUrlFormHelper(
            allow_edit, res_short_id, element_id, element_name="TestingProtocolUrl"
        )
        self.fields["value"].label = ""
...
class HelpPageUrlFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(HelpPageUrlFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class HelpPageUrlForm(ModelForm):
    def __init__(
        ...
        self.helper = HelpPageUrlFormHelper(
            allow_edit, res_short_id, element_id, element_name="HelpPageUrl"
        )
        self.fields["value"].label = ""
...
class SourceCodeUrlFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(SourceCodeUrlFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class SourceCodeUrlForm(ModelForm):
    def __init__(
        ...
        self.helper = SourceCodeUrlFormHelper(
            allow_edit, res_short_id, element_id, element_name="SourceCodeUrl"
        )
        self.fields["value"].label = ""
...
class IssuesPageUrlFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(IssuesPageUrlFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class IssuesPageUrlForm(ModelForm):
    def __init__(
        ...
        self.helper = IssuesPageUrlFormHelper(
            allow_edit, res_short_id, element_id, element_name="IssuesPageUrl"
        )
        self.fields["value"].label = ""
...
class MailingListUrlFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(MailingListUrlFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class MailingListUrlForm(ModelForm):
    def __init__(
        ...
        self.helper = MailingListUrlFormHelper(
            allow_edit, res_short_id, element_id, element_name="MailingListUrl"
        )
        self.fields["value"].label = ""
...
class RoadmapFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(RoadmapFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class RoadmapForm(ModelForm):
    def __init__(
        ...
        self.helper = RoadmapFormHelper(
            allow_edit, res_short_id, element_id, element_name="Roadmap"
        )
        self.fields["value"].label = ""
...
class ShowOnOpenWithListFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(ShowOnOpenWithListFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class ShowOnOpenWithListForm(ModelForm):
    def __init__(
        ...
        self.helper = ShowOnOpenWithListFormHelper(
            allow_edit, res_short_id, element_id, element_name="ShowOnOpenWithList"
        )
        self.fields["value"].label = ""
...
class VersionFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(VersionFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class VersionForm(ModelForm):
    def __init__(
        ...
        self.helper = VersionFormHelper(
            allow_edit, res_short_id, element_id, element_name="ToolVersion"
        )
        self.fields["value"].label = ""
        ...
        **kwargs
        ...
        layout = Layout(
            Row(
                Column(
                    Field(
                        "value", css_class=field_width, placeholder="Type URL here..."
                    ),
                    css_class="col-sm-6",
                ),
                Column(
        ...
        super(ToolIconFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )
...
class ToolIconForm(ModelForm):
    def __init__(
        ...
        self.helper = ToolIconFormHelper(
            allow_edit, res_short_id, element_id, element_name="ToolIcon", **kwargs
        )
        self.fields["value"].label = ""
...
class SupportedResTypesForm(ModelForm):
    supported_res_types = forms.MultipleChoiceField(
        choices=get_SupportedResTypes_choices(),
...
class SupportedResTypesValidationForm(forms.Form):
    supported_res_types = forms.MultipleChoiceField(
        choices=get_SupportedResTypes_choices(), required=False
    )
...
class SupportedAggTypeFormHelper(BaseFormHelper):
    def __init__(
        ...
        **kwargs
        ...
        super(SupportedAggTypeFormHelper, self).__init__(
            allow_edit, res_short_id, element_id, element_name, layout, *args, **kwargs
        )


class SupportedAggTypesForm(ModelForm):
    supported_agg_types = forms.MultipleChoiceField(
        choices=get_SupportedAggTypes_choices(),
        widget=forms.CheckboxSelectMultiple(
            attrs={"style": "width:auto;margin-top:-5px"}
        ),
    )
    ...
    def __init__(
        ...
        self.helper = SupportedAggTypeFormHelper(
            allow_edit, res_short_id, element_id, element_name="SupportedAggTypes"
        )
...
class SupportedAggTypesValidationForm(forms.Form):
    supported_agg_types = forms.MultipleChoiceField(
        choices=get_SupportedAggTypes_choices(), required=False
    )
...
class SupportedSharingStatusForm(ModelForm):
    sharing_status = forms.MultipleChoiceField(
        choices=get_SupportedSharingStatus_choices(),
        widget=forms.CheckboxSelectMultiple(
            attrs={"style": "width:auto;margin-top:-5px"}
        ),
    )
...
class SupportedSharingStatusValidationForm(forms.Form):
    sharing_status = forms.MultipleChoiceField(
        choices=get_SupportedSharingStatus_choices(), required=False
    )
