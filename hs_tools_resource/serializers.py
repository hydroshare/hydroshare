...
from .models import (
    ...
    RequestUrlBase,
    ToolVersion,
    SupportedResTypeChoices,
    SupportedResTypes,
    SupportedSharingStatusChoices,
    SupportedSharingStatus,
    ToolIcon,
    ToolMetaData,
    SupportedAggTypes,
    SupportedAggTypeChoices,
...
class SupportedResTypesMetaDataSerializer(serializers.ModelSerializer):
    supported_res_types = SupportedResTypeChoicesMetaDataSerializer(
...
class SupportedAggTypesMetaDataSerializer(serializers.ModelSerializer):
    supported_agg_types = SupportedAggTypeChoicesMetaDataSerializer(
        required=False, many=True
    )
...
class SupportedSharingStatusMetaDataSerializer(serializers.ModelSerializer):
    sharing_status = SupportedSharingStatusChoicesMetaDataSerializer(
        required=False, many=True
    )
...
class ToolMetaDataSerializer(CoreMetaDataSerializer):
    ...
    url_base_aggregation = RequestUrlBaseAggregationMetaDataSerializer(
    ...
    supported_resource_types = SupportedResTypesMetaDataSerializer(
        required=False, many=False
    )
    supported_aggregation_types = SupportedAggTypesMetaDataSerializer(
        required=False, many=False
    )
    app_icon = ToolIconMetaDataSerializer(required=False, many=False)
    supported_sharing_statuses = SupportedSharingStatusMetaDataSerializer(
        required=False, many=False
    )
    supported_file_extensions = SupportedFileExtensionsMetaDataSerializer(
        required=False, many=False
    )
