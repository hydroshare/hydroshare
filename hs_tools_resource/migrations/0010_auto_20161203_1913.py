...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RenameField(model_name="toolicon", old_name="url", new_name="value"),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(
                to="hs_tools_resource.SupportedResTypeChoices", blank=True
            ),
        ),
        migrations.AlterField(
            ...
            name="sharing_status",
            field=models.ManyToManyField(
                to="hs_tools_resource.SupportedSharingStatusChoices", blank=True
            ),
        ),
    ]
