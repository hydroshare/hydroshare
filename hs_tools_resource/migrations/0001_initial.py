        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_type",
                    models.ForeignKey(
                        related_name="hs_tools_resource_fee_related",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_type",
                    models.ForeignKey(
                        related_name="hs_tools_resource_requesturlbase_related",
                        on_delete=models.CASCADE,
                        to="contenttypes.ContentType",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "short_id",
                    models.CharField(
                        default=hs_core.models.short_id, max_length=32, db_index=True
                    ),
                ),
                (
                    "doi",
                    models.CharField(
                        help_text=b"Permanent identifier. Never changes once it's been set.",
                        max_length=1024,
                        null=True,
                        db_index=True,
                        blank=True,
                ...
                (
                    "creator",
                    models.ForeignKey(
                        related_name="creator_of_hs_tools_resource_toolresource",
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        related_name="group_editable_hs_tools_resource_toolresource",
                        null=True,
                        to="auth.Group",
                        blank=True,
                    ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        related_name="user_editable_hs_tools_resource_toolresource",
                        null=True,
                        to=settings.AUTH_USER_MODEL,
                        blank=True,
                    ),
                ...
                (
                    "last_changed_by",
                    models.ForeignKey(
                        related_name="last_changed_hs_tools_resource_toolresource",
                        on_delete=models.SET_NULL,
                        to=settings.AUTH_USER_MODEL,
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        related_name="owns_hs_tools_resource_toolresource",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        related_name="group_viewable_hs_tools_resource_toolresource",
                        null=True,
                        to="auth.Group",
                        blank=True,
                    ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        related_name="user_viewable_hs_tools_resource_toolresource",
                        null=True,
                        to=settings.AUTH_USER_MODEL,
                        blank=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_type",
                    models.ForeignKey(
                        related_name="hs_tools_resource_toolresourcetype_related",
                        on_delete=models.CASCADE,
                        to="contenttypes.ContentType",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_type",
                    models.ForeignKey(
                        related_name="hs_tools_resource_toolversion_related",
                        on_delete=models.CASCADE,
                        to="contenttypes.ContentType",
                    ),
                ),
