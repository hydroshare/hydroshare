...
def landing_page(request, page):
    ...
    if not edit_resource:
        ...
        context['supported_res_types'] = ", ".join(new_supported_res_types_array) if \
                                        content_model.metadata.supported_res_types.first() else None
        ...
        if not url_base:
            url_base = RequestUrlBase.create(content_object=content_model.metadata,
                                             resShortID=content_model.short_id, value="")
