    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edit_groups', models.ManyToManyField(help_text=b'This is the set of CommonsShare Groups who can edit the resource', related_name='group_editable_hs_app_timeseries_timeseriesresource', null=True, to='auth.Group', blank=True)),
                ('edit_users', models.ManyToManyField(help_text=b'This is the set of CommonsShare Users who can edit the resource', related_name='user_editable_hs_app_timeseries_timeseriesresource', null=True, to=settings.AUTH_USER_MODEL, blank=True)),
                ...
                ('view_groups', models.ManyToManyField(help_text=b'This is the set of CommonsShare Groups who can view the resource', related_name='group_viewable_hs_app_timeseries_timeseriesresource', null=True, to='auth.Group', blank=True)),
                ('view_users', models.ManyToManyField(help_text=b'This is the set of CommonsShare Users who can view the resource', related_name='user_viewable_hs_app_timeseries_timeseriesresource', null=True, to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
                'ordering': ('_order',),
