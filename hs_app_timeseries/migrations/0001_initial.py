...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('hs_core', '0002_auto_20141124_1938'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_id', models.CharField(default=b'1f0b3947b139482d9fc25fb644d2ed75', max_length=32, db_index=True)),
                ...
                ('edit_groups', models.ManyToManyField(help_text=b'This is the set of Hydroshare Groups who can edit the resource', related_name='group_editable_hs_app_timeseries_timeseriesresource', null=True, to='auth.Group', blank=True)),
                ('edit_users', models.ManyToManyField(help_text=b'This is the set of Hydroshare Users who can edit the resource', related_name='user_editable_hs_app_timeseries_timeseriesresource', null=True, to=settings.AUTH_USER_MODEL, blank=True)),
                ...
                ('owners', models.ManyToManyField(help_text=b'The person who uploaded the resource', related_name='owns_hs_app_timeseries_timeseriesresource', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(related_name='timeseriesresources', verbose_name='Author', to=settings.AUTH_USER_MODEL)),
                ('view_groups', models.ManyToManyField(help_text=b'This is the set of Hydroshare Groups who can view the resource', related_name='group_viewable_hs_app_timeseries_timeseriesresource', null=True, to='auth.Group', blank=True)),
                ('view_users', models.ManyToManyField(help_text=b'This is the set of Hydroshare Users who can view the resource', related_name='user_viewable_hs_app_timeseries_timeseriesresource', null=True, to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
                'ordering': ('_order',),
