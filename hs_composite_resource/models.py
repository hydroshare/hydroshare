...
class CompositeResource(BaseResource):
    ...
    def get_aggregation_by_dataset_name(self, dataset_name):
        ...
        for aggregation in self.logical_files:
            ...
            if aggregation.dataset_name.rstrip('/') == dataset_name:
                return aggregation

        raise ObjectDoesNotExist("No matching aggregation was found for name:{}".format(dataset_name))
