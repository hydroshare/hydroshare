...
def landing_page(request, page):
    ...
    if request.user.is_authenticated and request.user.uaccess.can_change_resource(
        content_model
    ):
    ...
    file_type_missing_metadata = {
        "file_type_missing_metadata": content_model.get_missing_file_type_metadata_info()
    }
    context.update(file_type_missing_metadata)
    data_services_urls = {"data_services_urls": content_model.get_data_services_urls()}
