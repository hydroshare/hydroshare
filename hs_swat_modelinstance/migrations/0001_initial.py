    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('object_id', models.PositiveIntegerField()),
                ('warm_up_period', models.CharField(max_length=100, null=True, verbose_name='Warm-up period in years', blank=True)),
                ('rainfall_time_step_type', models.CharField(blank=True, max_length=100, null=True, choices=[('Daily', 'Daily'), ('Sub-hourly', 'Sub-hourly')])),
                ('rainfall_time_step_value', models.CharField(max_length=100, null=True, blank=True)),
                ('routing_time_step_type', models.CharField(blank=True, max_length=100, null=True, choices=[('Daily', 'Daily'), ('Hourly', 'Hourly')])),
                ('routing_time_step_value', models.CharField(max_length=100, null=True, blank=True)),
                ('simulation_time_step_type', models.CharField(blank=True, max_length=100, null=True, choices=[('Annual', 'Annual'), ('Monthly', 'Monthly'), ('Daily', 'Daily'), ('Hourly', 'Hourly')])),
                ('simulation_time_step_value', models.CharField(max_length=100, null=True, blank=True)),
                ('watershed_area', models.CharField(max_length=100, null=True, verbose_name='Waterhsed area in square kilometers', blank=True)),
                ...
                ('DEM_resolution', models.CharField(max_length=100, null=True, verbose_name='DEM resolution in meters', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('object_id', models.PositiveIntegerField()),
                ('simulation_type_name', models.CharField(max_length=100, verbose_name='Simulation type', choices=[('Normal Simulation', 'Normal Simulation'), ('Sensitivity Analysis', 'Sensitivity Analysis'), ('Auto-Calibration', 'Auto-Calibration')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(related_name='creator_of_hs_swat_modelinstance_swatmodelinstanceresource', to=settings.AUTH_USER_MODEL, help_text='This is the person who first uploaded the resource')),
                ('edit_groups', models.ManyToManyField(help_text='This is the set of Hydroshare Groups who can edit the resource', related_name='group_editable_hs_swat_modelinstance_swatmodelinstanceresource', null=True, to='auth.Group', blank=True)),
                ('edit_users', models.ManyToManyField(help_text='This is the set of Hydroshare Users who can edit the resource', related_name='user_editable_hs_swat_modelinstance_swatmodelinstanceresource', null=True, to=settings.AUTH_USER_MODEL, blank=True)),
                ('last_changed_by', models.ForeignKey(related_name='last_changed_hs_swat_modelinstance_swatmodelinstanceresource', to=settings.AUTH_USER_MODEL, help_text='The person who last changed the resource', null=True)),
                ('owners', models.ManyToManyField(help_text='The person who has total ownership of the resource', related_name='owns_hs_swat_modelinstance_swatmodelinstanceresource', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(related_name='swatmodelinstanceresources', verbose_name='Author', to=settings.AUTH_USER_MODEL)),
                ('view_groups', models.ManyToManyField(help_text='This is the set of Hydroshare Groups who can view the resource', related_name='group_viewable_hs_swat_modelinstance_swatmodelinstanceresource', null=True, to='auth.Group', blank=True)),
                ('view_users', models.ManyToManyField(help_text='This is the set of Hydroshare Users who can view the resource', related_name='user_viewable_hs_swat_modelinstance_swatmodelinstanceresource', null=True, to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
                'ordering': ('_order',),
