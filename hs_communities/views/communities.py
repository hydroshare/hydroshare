...
def group_json(group):
    ...
    if group is not None:
        ...
        return {
            ...
            'discoverable': 1 if group.gaccess.discoverable == True else 0,
            'public': 1 if group.gaccess.public == True else 0,
            'shareable': 1 if group.gaccess.shareable == True else 0,
            'auto_approve': 1 if group.gaccess.auto_approve == True else 0,
