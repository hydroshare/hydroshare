...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.cv'
        db.add_column(u'theme_userprofile', 'cv',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.details'
        db.add_column(u'theme_userprofile', 'details',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.cv'
        db.delete_column(u'theme_userprofile', 'cv')

        # Deleting field 'UserProfile.details'
        db.delete_column(u'theme_userprofile', 'details')
    ...
    models = {
        ...
        u'theme.userprofile': {
            ...
            'details': ('mezzanine.core.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
