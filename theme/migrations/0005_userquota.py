        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warning_content_prepend', models.TextField(
                    default=b'Your quota for xDCIShare resources is {allocated}{unit} in {zone} zone. You currently have resources that consume {used}{unit}, {percent}% of your quota. Once your quota reaches 100% you will no longer be able to create new resources in xDCIShare. ')),
                ('grace_period_content_prepend', models.TextField(
                    default=b'You have exceeded your xDCIShare quota. Your quota for xDCIShare resources is {allocated}{unit} in {zone} zone. You currently have resources that consume {used}{unit}, {percent}% of your quota. You have a grace period until {cut_off_date} to reduce your use to below your quota, or to acquire additional quota, after which you will no longer be able to create new resources in xDCIShare. ')),
                ('enforce_content_prepend', models.TextField(
                    default=b'Your action to add content to xDCIShare was refused because you have exceeded your quota. Your quota for xDCIShare resources is {allocated}{unit} in {zone} zone. You currently have resources that consume {used}{unit}, {percent}% of your quota. ')),
