    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    mezzanine.core.fields.FileField(
                        max_length=255, verbose_name="Header Background", blank=True
                    ),
                ),
                (
                    "header_image",
                    mezzanine.core.fields.FileField(
                        max_length=255,
                        null=True,
                        verbose_name="Header Image (optional)",
                        blank=True,
                    ),
                ),
                (
                    "welcome_heading",
                    models.CharField(default="Welcome", max_length=100),
                ),
                ("content", mezzanine.core.fields.RichTextField()),
                (
                    "recent_blog_heading",
                    models.CharField(default="Latest blog posts", max_length=100),
                ),
                (
                    "number_recent_posts",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "icon",
                    models.CharField(
                        help_text="Enter the name of a font awesome icon, i.e. fa-eye. A list is available here http://fontawesome.io/",
                        max_length=50,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "col1_heading",
                    models.CharField(default="Contact us", max_length=200),
                ),
                ...
                (
                    ...
                    mezzanine.core.fields.RichTextField(
                        help_text="If present will override the social network icons.",
                        blank=True,
                    ),
                ),
                ...
                (
                    "site",
                    models.ForeignKey(
                        editable=False, on_delete=models.CASCADE, to="sites.Site"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "picture",
                    models.ImageField(null=True, upload_to="profile", blank=True),
                ),
                (
                    "title",
                    models.CharField(
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Uncheck to make your profile contact information and details private.",
                    ),
                ),
                (
                    "cv",
