    ...
    def handle(self, *args, **options):
        ...
        for res in resources:
            try:
                ...
                # test artifects
                print res.short_id + ' raised SessionException when setting quota holder: ' + ex.stderr
                continue
                ...
                print res.short_id + ' raised AttributeError when setting quota holder: ' + ex.message
                continue
            except ValueError as ex:
                # when federation is not set up correctly, istorage does not have a session
                # attribute, hence raise AttributeError - ignore for testing and it should not
                # happen in production where federation is set up properly
                print res.short_id + ' raised ValueError when setting quota holder: ' + ex.message
                continue
