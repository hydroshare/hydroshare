...
def get_quota_message(user):
    ...
    for uq in user.quotas.all():
        ...
        if percent >= hard_limit or (percent >= 100 and uq.remaining_grace_period == 0):
            ...
            return_msg += msg_template_str.format(
            ...
            msg_template_str = "{}{}\n".format(
                qmsg.grace_period_content_prepend, qmsg.content
            )
            return_msg += msg_template_str.format(
                used=rounded_used_val,
                unit=uq.unit,
            ...
            msg_template_str = "{}{}\n".format(
                qmsg.warning_content_prepend, qmsg.content
            )
            return_msg += msg_template_str.format(
                used=rounded_used_val,
                unit=uq.unit,
            ...
            return_msg += qmsg.warning_content_prepend.format(
                allocated=uq.allocated_value,
                unit=uq.unit,
                used=rounded_used_val,
                zone=uq.zone,
