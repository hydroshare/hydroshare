...
Vue.component('profile-link', {
    ...
    data: function () {
        return {
            user: {
                user_type: "initial_link",
                access: "initial_link",
                id: "initial_link",
                pictureUrl: "initial_link",
                best_name: "initial_link",
                user_name: "initial_link",
                can_undo: "initial_link",
                email: "initial_link",
                organization: "initial_link",
                title: "initial_link",
                contributions: "initial_link",
