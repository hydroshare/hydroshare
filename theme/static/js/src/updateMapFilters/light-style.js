import { MERGED_PMTILES_URL, VPU_PMTILES_URL } from "../config.js";

export function useLightStyle() {
    return{
  "version": 8,
  "sources": {
    "protomaps": {
    ...
    "hydrofabric": {
      "type": "vector",
      "url": `pmtiles://${MERGED_PMTILES_URL}`,
  ...
  "glyphs": "https://communityhydrofabric.s3.us-east-1.amazonaws.com/map/basemaps-assets-main/fonts/{fontstack}/{range}.pbf",
  "sprite": "https://communityhydrofabric.s3.us-east-1.amazonaws.com/map/basemaps-assets-main/sprites/v4/light"
}
}