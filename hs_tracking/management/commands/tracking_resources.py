...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--days", type=int, dest="days", default=31, help="number of days to list"
        )
        parser.add_argument(
            "--resources",
            type=int,
    ...
    def handle(self, *args, **options):
        ...
        for v in recent:
            ...
            print(
                "  published={} public={} discoverable={} first author={}".format(
                    v.published, v.public, v.discoverable, v.first_creator
                )
            )
