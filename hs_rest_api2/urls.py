...
urlpatterns = [
    ...
    url(
        r"^resource/(?P<pk>[0-9a-f-]+)/json/$",
        resource_metadata_json,
        name="resource_metadata_json",
    ),
    url(
        r"^resource/(?P<pk>[0-9a-f-]+)/json/GeographicFeature/(?P<aggregation_path>.*)$",
        geographic_feature_metadata_json,
        name="geographic_feature_metadata_json",
    ),
    url(
        r"^resource/(?P<pk>[0-9a-f-]+)/json/GeographicRaster/(?P<aggregation_path>.*)$",
        geographic_raster_metadata_json,
        name="geographic_raster_metadata_json",
    ),
    url(
        r"^resource/(?P<pk>[0-9a-f-]+)/json/TimeSeries/(?P<aggregation_path>.*)$",
        time_series_metadata_json,
        name="time_series_metadata_json",
    ),
    url(
        r"^resource/(?P<pk>[0-9a-f-]+)/json/FileSet/(?P<aggregation_path>.*)$",
        file_set_metadata_json,
        name="file_set_metadata_json",
    ),
    url(
        r"^resource/(?P<pk>[0-9a-f-]+)/json/Multidimensional/(?P<aggregation_path>.*)$",
        multidimensional_metadata_json,
        name="multidimensional_metadata_json",
    ),
    url(
        r"^resource/(?P<pk>[0-9a-f-]+)/json/ReferencedTimeSeries/(?P<aggregation_path>.*)$",
        referenced_time_series_metadata_json,
        name="referenced_time_series_metadata_json",
    ),
    url(
        r"^resource/(?P<pk>[0-9a-f-]+)/json/SingleFile/(?P<aggregation_path>.*)$",
        single_file_metadata_json,
        name="single_file_metadata_json",
    ),
    url(
        r"^resource/(?P<pk>[0-9a-f-]+)/json/ModelInstance/(?P<aggregation_path>.*)$",
        model_instance_metadata_json,
        name="model_instance_metadata_json",
    ),
    url(
        r"^resource/(?P<pk>[0-9a-f-]+)/json/ModelProgram/(?P<aggregation_path>.*)$",
        model_program_metadata_json,
