...
from hs_rest_api2.metadata import (
    ingest_resource_metadata,
    ingest_aggregation_metadata,
    aggregation_metadata_json_loads,
    resource_metadata_json_loads,
)
...
@swagger_auto_schema(
    method="put",
    request_body=serializers.ResourceMetadataInSerializer,
...
@swagger_auto_schema(
    method="put",
    request_body=serializers.GeographicFeatureMetadataInSerializer,
    response={204: None},
...
@swagger_auto_schema(
    method="put",
    request_body=serializers.GeographicRasterMetadataInSerializer,
    response={204: None},
...
@swagger_auto_schema(
    method="put",
    request_body=serializers.TimeSeriesMetadataInSerializer,
    response={204: None},
...
@swagger_auto_schema(
    method="put",
    request_body=serializers.FileSetMetadataInSerializer,
    response={204: None},
...
@swagger_auto_schema(
    method="put",
    request_body=serializers.MultidimensionalMetadataInSerializer,
    response={204: None},
...
@swagger_auto_schema(
    method="put",
    request_body=serializers.ReferencedTimeSeriesMetadataInSerializer,
...
@swagger_auto_schema(
    method="put",
    request_body=serializers.SingleFileMetadataInSerializer,
    response={204: None},
...
@swagger_auto_schema(
    method="put",
    request_body=serializers.ModelProgramMetadataInSerializer,
    response={204: None},
...
@swagger_auto_schema(
    method="put",
    request_body=serializers.ModelInstanceMetadataInSerializer,
    response={204: None},
