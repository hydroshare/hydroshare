...
from hs_rest_api2.metadata import resource_metadata_json, ingest_resource_metadata, aggregation_metadata_json_loads, \
...
@swagger_auto_schema(method='put', request_body=serializers.ResourceMetadataInSerializer, response={204: None},
...
def resource_metadata_json(request, pk):
    if request.method == 'GET':
        ...
        md_json = resource_metadata_json(resource)
