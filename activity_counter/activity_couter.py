    ...
    for file_path in file_list:
        try:
            ...
            for chunk in pd.read_csv(file_path, chunksize=chunk_size, usecols=usecols):
                ...
                if total_chunks_estimate:
                    progress_msg = f"  Processing chunk {chunk_counter} (out of ~{total_chunks_estimate} chunks in this file) with {chunk_rows} rows..."
                else:
                ...
                if (chunk_counter <= 3 or chunk_counter % 10 == 0 or 
                    (total_chunks_estimate and chunk_counter >= total_chunks_estimate - 3)):
                    print(progress_msg)
